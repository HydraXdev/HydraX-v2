#!/bin/bash
# Setup reverse tunnel for easy Windows access

echo "=== BITTEN EA Transfer Service ==="
echo "This will create an easy way for Windows to grab the EA"
echo ""

# Option 1: Simple Python HTTP server with the EA
cat > /root/HydraX-v2/serve_ea.py << 'EOF'
#!/usr/bin/env python3
import http.server
import socketserver
import os
...
chmod +x /root/HydraX-v2/serve_ea.py

# Start the server
echo "Starting EA download server..."
python3 /root/HydraX-v2/serve_ea.py