...
{
Print("========================================================");
 Print("BITTEN Bridge ZMQ Controller v7.01 - With Tick Streaming");
 Print("========================================================");
 ...
 SendStatusMessage("startup", "EA v7.01 initialized with tick streaming");
...
Print("📥 Received: ", message);
 ...
 {
    // Suppress warning, optionally log if needed
