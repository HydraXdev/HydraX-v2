"""
BITTEN Main Signal Engine - APEX v5.0 ONLY
...
from apex_v5_integration import APEXv5IntegrationManager

# This is the ONLY signal engine that should be imported anywhere in the system
MainSignalEngine = APEXv5IntegrationManager

print("✅ APEX v5.0 Engine Active - Ultra-Aggressive Mode (TCS 35-95)")
