...
_The enhanced MT5 bridge with socket functionality is fully deployed and ready. Production safety measures ensure users can never accidentally execute simulation trades. When AWS connectivity is restored, all enhanced features will be immediately available._
