       ...
       <div className="tier-comparison">
         ...
         <div className="upgrade-arrow">
           <button
             ...
             onClick={() => startUpgrade(targetTier)}
           >
       ...
       this.tutorialSteps = {
         nibbler_onboarding: [
           ...
           },
           {
             ...
             content:
               "See this flashing indicator? That's a trading opportunity.",
             persona: "drill",
