    ...
    def dispatch_signal_via_athena(self, signal_data: Dict) -> Dict:
        ...
        try:
            if not self.mission_brain:
                ...
                return {
                    "success": True,
                    "dispatch_results": [{"user_id": "7176191872", "status": "dispatched", "method": "fallback"}],
                }
            ...
            for mission in missions:
                try:
                    ...
                    dispatch_results.append({"user_id": mission.user_id, "status": "failed", "error": str(e)})

            return {"success": True, "dispatch_results": dispatch_results, "total_missions": len(missions)}

        except Exception as e:
            logger.error(f"Dispatch failed: {e}")
            return {"success": False, "error": str(e), "dispatch_results": []}
