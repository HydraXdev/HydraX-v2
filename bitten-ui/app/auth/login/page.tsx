    ...
    switch (error) {
      case "expired":
        return {
          ...
          description:
            message ||
            "Your session has expired. Please access the page from Telegram again.",
      ...
      case "invalid":
        return {
          ...
          description:
            message ||
            "Invalid access. Please use the links provided in Telegram.",
          action:
            "Use /brief, /war, /live, or /notebook commands in the BITTEN bot.",
        };
      default:
        return {
          title: "🎯 BITTEN Access",
        ...
        <div className="panel-elevated p-8 text-center">
          ...
          <div className="space-y-4">
            <div className="bg-overlay/50 rounded p-4 border border-active/30">
              <p className="text-sm text-tertiary font-code">{action}</p>
            </div>

            <div className="text-xs text-muted">
              <p>Secure access powered by BITTEN Protocol</p>
              <p className="mt-1">
                All links expire after 5 minutes for security
              </p>
            </div>
          </div>

          <div className="mt-8 space-y-2">
            <h3 className="text-sm font-tactical text-cyan">
              Available Commands:
            </h3>
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="bg-secondary/30 rounded px-2 py-1 font-code">
                /brief
              </div>
              <div className="bg-secondary/30 rounded px-2 py-1 font-code">
                /war
