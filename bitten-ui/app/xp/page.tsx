...
const badges = [
  ...
  },
  {
    id: 3,
    name: "Speed Demon",
    description: "Execute 5 trades in one hour",
    icon: Zap,
    unlocked: false,
    rarity: "epic",
  },
...
const shopItems = [
  {
    id: 1,
    name: "Sniper Shot",
    description: "90% confidence bypass",
    cost: 500,
    icon: Target,
    available: true,
  },
  {
    id: 2,
    name: "Double Down",
    description: "4% risk on next trade",
    cost: 1000,
    icon: TrendingUp,
    available: true,
  },
  {
    id: 3,
    name: "Rapid Fire",
    description: "No cooldown for 1 hour",
    cost: 750,
    icon: Zap,
    available: false,
  },
  {
    id: 4,
    name: "XP Boost",
    description: "2x XP for 10 trades",
    cost: 1000,
    icon: Star,
    available: true,
  },
...
export default function XPDashboardPage() {
  ...
  const levelThresholds = [
    0, 500, 1000, 1500, 2500, 3500, 5500, 7500, 10000, 13000, 16000,
  ];
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    >
                      <Icon
                        size={24}
                        className={
                          badge.unlocked ? "text-white" : "text-tertiary"
                        }
                      />
                    </div>
          ...
          {shopItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <span
                    className={`text-sm font-bold ${canAfford ? "text-warning" : "text-tertiary"}`}
                  >
                    {item.cost} XP
                  </span>
