    ...
    <div className="min-h-screen bg-gray-950 text-green-400 p-2 sm:p-4 font-mono">
      ...
      <div className="border-2 border-yellow-500 bg-black/70 p-3 mb-3">
            ...
            <div
              ...
              className={`w-12 h-12 border-2 flex items-center justify-center ${
                i < openSlots
                  ...
                  : "border-gray-600 bg-gray-900/30 text-gray-600"
              }`}
            >
              {i < openSlots ? "●" : "○"}
            </div>
        ...
        <div className="text-xs text-green-500 mt-2">
          {openSlots}/{slots} ACTIVE • {availableSlots} AVAILABLE
        </div>
      </div>
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <div
                      className={`text-sm font-bold ${trade.equity >= 0 ? "text-green-400" : "text-red-400"}`}
                    >
      ...
      <div className="grid grid-cols-2 gap-2 mb-3">
        <button
          onClick={onAlerts}
          className="border-2 border-green-500 bg-green-900/30 p-3 hover:bg-green-900/50 transition-colors text-green-400 font-bold"
        >
          📡 ALERTS
        </button>
        <button
        ...
        <button
          onClick={onStats}
          className="border-2 border-blue-500 bg-blue-900/30 p-3 hover:bg-blue-900/50 transition-colors text-blue-400 font-bold"
        >
          📊 STATS
        </button>
        <button
          onClick={onCloseAll}
          className="border-2 border-red-500 bg-red-900/30 p-3 hover:bg-red-900/50 transition-colors text-red-400 font-bold"
      ...
      <button
        onClick={onNotebook}
        className="w-full border-2 border-purple-500 bg-purple-900/30 p-3 hover:bg-purple-900/50 transition-colors text-purple-400 font-bold"
      >
        📓 NOTEBOOK
      </button>
    </div>
