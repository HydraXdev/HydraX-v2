...
class ShepherdCLI:
    ...
    def trace(self, module: str) -> Dict[str, Any]:
        ...
        connections = {
            ...
            "dependencies": ["config_manager", "database_connection", "logging_system"],
            "status": "active",
            "health": "healthy",
        }
    ...
    def why(self, trigger: str) -> Dict[str, Any]:
        ...
        chain = {
            ...
            "chain": [
                ...
                {"step": 3, "component": "signal_generator", "action": "Generated trading signal", "output": trigger},
            ],
...
print(result)  # {"action": "BUY", "confidence": 0.85, "metadata": {...}}
                ...
                "affected_modules": [
                    {
                        ...
                        "impact": "medium",
                        "description": "Risk thresholds will need adjustment",
                    },
                    {
                        "module": "signal_processor",
                        "impact": "high",
                        "description": "Signal generation logic will be modified",
                    },
                    {
                        "module": "notification_handler",
                        "impact": "low",
                        "description": "New notification type may be needed",
                    },
                ],
                "performance_impact": {
                    "latency": "+2ms average",
    ...
    def checkpoint(self, label: str) -> Dict[str, Any]:
        ...
        checkpoint_data = {
            ...
            "system_state": {
                ...
                "configuration": {"risk_level": "medium", "signal_threshold": 0.75, "max_positions": 5},
                "performance_metrics": {"uptime": "48h 23m", "signals_processed": 1543, "success_rate": 0.67},
            },
            "metadata": {"created_by": "shepherd_cli", "version": "1.0.0", "environment": "production"},
        }
    ...
    def _update_checkpoint_index(self, checkpoint_id: str, label: str):
        ...
        index["checkpoints"].append({"id": checkpoint_id, "label": label, "timestamp": datetime.now().isoformat()})
