...
⏰ Expires in 10 minutes"""
    ...
    await update.effective_chat.send_message(
        text=message, parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(keyboard)
    )
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
        ...
        await query.edit_message_text(
            text=full_intel, parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(keyboard)
        )
...
📊 Check /positions for status""",
        ...
        await query.edit_message_text(text="❌ Signal skipped\n\nWaiting for next opportunity...")
...
Total P/L: +$24.50"""
    ...
    await update.effective_chat.send_message(text=positions_text, parse_mode=ParseMode.MARKDOWN)
