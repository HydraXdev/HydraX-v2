...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("/var/log/bitten-watchdog.log"), logging.StreamHandler()],
)
                    ...
                    if self.failure_count >= self.max_failures:
                        if self.activate_nuclear_fallback():
                            ...
                            self.send_telegram_alert(
                                "💥 CRITICAL: Nuclear fallback failed - immediate attention required"
                            )
