...
class CitadelAnalyzer:
    ...
    def analyze_signal(
        ...
        try:
            ...
            shield_result = self.scoring_engine.calculate_score(
                signal_analysis, regime_analysis, liquidity_analysis, tf_analysis
            )
            ...
            if user_id:
                shield_result = self._apply_user_personalization(shield_result, user_id, signal_analysis)
            ...
            logger.info(
                f"CITADEL analysis complete for {pair}: "
    ...
    def format_for_telegram(self, signal: Dict[str, Any], shield_analysis: Dict[str, Any], compact: bool = True) -> str:
        """
        ...
        """
        return self.telegram_formatter.format_enhanced_signal(signal, shield_analysis, compact)
    ...
    def log_trade_outcome(
        self, signal_id: str, user_id: int, outcome: str, pips_result: float, followed_shield: bool
    ) -> bool:
        """
        ...
        Returns:
            Success status
        """
        return self.shield_logger.log_trade_outcome(signal_id, user_id, outcome, pips_result, followed_shield)
    ...
    def _add_to_cache(self, signal_id: str, analysis: Dict[str, Any]):
        ...
        if len(self.analysis_cache) > 100:
            ...
            oldest_key = min(self.analysis_cache.keys(), key=lambda k: self.analysis_cache[k][1])
            del self.analysis_cache[oldest_key]

    def _apply_user_personalization(
        self, shield_result: Dict[str, Any], user_id: int, signal_analysis: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                if pair in enhanced_stream:
                    ...
                    logger.info(
                        f"Enhanced {pair} with live broker data: "
    ...
    def _detect_institutional_signals(self, enhanced_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if (
                momentum.get("momentum_direction") == "bullish"
                and signals["accumulation_distribution"] == "accumulation"
            ):
                signals["smart_money_direction"] = "bullish"
            elif (
                momentum.get("momentum_direction") == "bearish"
                and signals["accumulation_distribution"] == "distribution"
            ):
    ...
    def _assess_entry_quality(self, enhanced_data: Dict[str, Any], signal: Dict[str, Any]) -> Dict[str, Any]:
        ...
        assessment = {"quality_score": 0, "factors": [], "warnings": []}
