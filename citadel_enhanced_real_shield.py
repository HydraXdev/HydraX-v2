...
class CitadelEnhancedRealShield:
    ...
    def analyze_spread_quality(self, symbol: str, signal_data: Dict) -> Tuple[float, str]:
        ...
        try:
            ...
            self.spread_history[symbol].append({"spread": current_spread, "time": time.time()})
    ...
    def analyze_volume_strength(self, symbol: str, signal_data: Dict) -> Tuple[float, str]:
        ...
        try:
            ...
            self.volume_history[symbol].append({"volume": current_volume, "time": time.time()})
    ...
    def analyze_session_compatibility(self, symbol: str, signal_data: Dict) -> Tuple[float, str]:
        ...
        try:
            ...
            session_compatibility = {
                "OVERLAP": {"EURUSD": 2.5, "GBPUSD": 2.5, "EURJPY": 2.0, "GBPJPY": 2.0, "EURGBP": 1.5, "USDJPY": 1.5},
                "LONDON": {
                    "EURUSD": 2.0,
                    "GBPUSD": 2.0,
                    "EURGBP": 2.5,
                ...
                "NY": {"EURUSD": 2.0, "GBPUSD": 2.0, "USDCAD": 2.5, "USDJPY": 1.5, "USDCHF": 1.5},
                "ASIAN": {"USDJPY": 2.0, "AUDUSD": 2.0, "NZDUSD": 1.5, "EURJPY": 1.0, "AUDJPY": 1.5},
            }
    ...
    def calculate_enhanced_shield_score(self, signal_data: Dict) -> Dict:
        ...
        try:
            ...
            return self.create_shield_result(
                total_score, classification, components, insights, risk_multiplier, recommendation
            )
    ...
    def create_shield_result(
        ...
        recommendation: str = "Minimal risk approach",
    ) -> Dict:
    ...
    def enhance_signal_with_shield(self, signal_data: Dict) -> Dict:
        ...
        try:
            ...
            logger.info(
                f"🛡️ SHIELD ANALYSIS: {signal_data.get('pair', 'Unknown')} - "
...
if __name__ == "__main__":
    ...
    # Test signal
    test_signal = {"pair": "EURUSD", "direction": "BUY", "confidence": 85.0, "signal_type": "RAPID_ASSAULT"}
