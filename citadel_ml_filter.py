...
class CitadelMLFilter:
        ...
        try:
            if self.citadel_state_path.exists():
                ...
                return {
                    ...
                    "min_acceptable_probability": ml_config.get(
    ...
    def signal_to_features(self, signal_dict: Dict[str, Any]) -> Optional[np.ndarray]:
        ...
        try:
            ...
            tcs_score = float(signal_dict.get("tcs_score", signal_dict.get("confidence", signal_dict.get("score", 75))))
    ...
    def log_suppressed_signal(self, signal_dict: Dict[str, Any], win_probability: float, min_threshold: float):
    ...
    def filter_signal(self, signal_dict: Dict[str, Any]) -> Tuple[bool, Dict[str, Any]]:
        ...
        try:
            ...
            if not ml_config["enabled"]:
                return True, {"ml_filter_enabled": False, "filter_result": "disabled"}

            # Check for model override (emergency bypass)
            if ml_config["model_override"]:
                return True, {"ml_filter_enabled": True, "filter_result": "override_bypass"}
            ...
            if not should_allow:
                ...
                logger.info(
                    f"🚫 ML FILTER SUPPRESSED: {signal_dict.get('symbol', 'unknown')} "
            ...
            return True, {"ml_filter_enabled": True, "filter_result": "error", "error": str(e)}
