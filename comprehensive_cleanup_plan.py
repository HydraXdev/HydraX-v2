...
class BittenSystemCleaner:
    ...
    def get_cleanup_manifest(self):
        ...
        duplicate_groups = {
            ...
            "tcs_engine": {"keep": "core/tcs_engine_active.py", "archive": ["core/tcs_engine_v5.py"]},
            "risk_management": {
            ...
            "engine_engineer": {"keep": "engine_engineer_enhanced.py", "archive": ["core/engine_engineer_v2.py"]},
