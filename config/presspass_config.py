...
PRESS_PASS_TIER = {
    ...
    "restrictions": {"demo_only": True, "max_daily_trades": 10, "weekend_trading": False, "bridge_priority": "low"},
}
...
if __name__ == "__main__":
    ...
    print(
        f"  - Bridge Port Range: {config['bridge_base_port']}-{config['bridge_base_port'] + config['bridge_port_range']}"
    )
