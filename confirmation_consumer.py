...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("/root/HydraX-v2/logs/confirmation_consumer.log"), logging.StreamHandler()],
)
...
class ConfirmationConsumer:
    ...
    def get_statistics(self) -> Dict:
        ...
        return {
            ...
            "rejection_rate": (
                self.confirmations_rejected / max(1, self.confirmations_processed + self.confirmations_rejected)
            )
            * 100,
