...
class CoreMarketCollector:
    ...
    def generate_crypto_signal(self, symbol: str) -> dict:
        ...
        try:
            ...
            if (
                analysis["score"] < self.signal_threshold
                or analysis["confluence_count"] < self.confluence_requirement
            ...
            while self.running:
                ...
                if self.total_ticks > 0:
                    ...
                    if active_symbols:
                        ...
                        logger.info(
                            f"📈 Active: {', '.join(active_symbols)} | Total ticks: {self.total_ticks}{signal_stats}"
                        )
