...
class DataIntegrityEnforcer:
    ...
    BANNED_SOURCES = ["simulated", "synthetic", "test_data", "simulation", "fake", "mock", "placeholder", "backtest"]
        ...
        try:
            if self.bot_token:
                ...
                requests.post(
                    ...
                    json={"chat_id": self.alert_user_id, "text": alert_text, "parse_mode": "Markdown"},
                    timeout=5,
                )
...
if __name__ == "__main__":
    ...
    # Test valid data
    try:
        valid_data = {"signal_id": "VENOM_EURUSD_001", "source": "truth_log.jsonl", "profit": 50.0, "confidence": 89.5}
