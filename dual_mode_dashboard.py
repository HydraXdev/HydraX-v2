...
class DualModeDashboard:
    ...
    def calculate_signal_generation_frequency(self, signals: List[Dict]) -> Dict:
        ...
        return {"rapid_per_hour": rapid_count / hours, "sniper_per_hour": sniper_count / hours}
    ...
    def render_dashboard(self):
        ...
        if recent_outcomes:
            ...
            for outcome in sorted_outcomes:
                ...
                print(
                    f"   {result_icon} {mode_icon} {symbol} {result} {pips:+.1f} pips in {self.format_time_duration(time_to_complete)}"
                )
