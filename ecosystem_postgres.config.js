...
module.exports = {
  apps: [
    ...
    // NEW: Postgres Integration Services
    {
      ...
      env: {
        PYTHONPATH: '/root/HydraX-v2',
        POSTGRES_DSN: 'postgresql://bitten:bitten_secure_2025@localhost:5432/bitten'
      },
  ...
  deploy: {
    production: {
      ...
      path: '/root/HydraX-v2',
      'pre-deploy-local': '',
      'post-deploy': 'pip install -r requirements_postgres.txt && pm2 reload ecosystem_postgres.config.js --env production',
      'pre-setup': '',
