...
class ValidationHarness:
    ...
    def setup_logging(self):
        logging.basicConfig(
            ...
            handlers=[logging.FileHandler("/root/HydraX-v2/validation_harness.log"), logging.StreamHandler()],
        )
                        ...
                        outcomes.append(
                            {
                                ...
                                "duration_ms": (data.get("duration_minutes", 0) * 60 * 1000)
                                or data.get("duration_ms", 0),
    ...
    def get_outcomes_from_jsonl(self) -> List[Dict]:
        ...
        outcomes = []
        jsonl_files = ["/root/HydraX-v2/dynamic_tracking.jsonl", "/root/HydraX-v2/comprehensive_tracking.jsonl"]
    ...
    def compare_metrics(self, bus_metrics: Dict, jsonl_metrics: Dict) -> Dict:
        ...
        deltas = {"totals": {}, "sums": {}, "ratios": {}, "violations": [], "status": "PASS"}
        ...
        for key in ["trades", "wins", "losses"]:
            ...
            deltas["totals"][key] = {"bus": bus_val, "jsonl": jsonl_val, "delta": delta, "delta_pct": delta_pct}
        ...
        for key in ["pips_net", "pnl_ccy"]:
            ...
            deltas["sums"][key] = {"bus": bus_val, "jsonl": jsonl_val, "delta": delta, "delta_pct": delta_pct}
        ...
        for key in ["win_rate", "rr_avg"]:
            ...
            deltas["ratios"][key] = {"bus": bus_val, "jsonl": jsonl_val, "delta": delta}
    ...
    def check_consistency(self, outcomes: List[Dict]) -> Dict:
        ...
        violations = []
        edge_cases = {"partial_fills": 0, "manual_closes": 0, "breakevens": 0, "timeouts": 0, "trail_stops": 0}
    ...
    def cross_source_audit(self, bus_metrics: Dict, jsonl_metrics: Dict) -> Dict:
        ...
        for trade_id in sample_trades:
            ...
            audit = {"trade_id": trade_id, "fields_match": True, "mismatches": []}
