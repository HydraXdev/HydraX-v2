...
class FirePacketBuilder:
    ...
    def build_fire_packet(self, signal_data: Dict, user_data: Dict) -> Dict:
        ...
        pip_values = {
            ...
            'EURJPY': 10.0, 'GBPJPY': 10.0, 'EURGBP': 10.0,
...
class RuleSlotEngine:
    ...
    def _get_user_limits(self, uid: str) -> Dict:
        ...
        try:
            with self.get_db_connection() as conn:
                ...
                current_mode, max_auto_slots, auto_slots_in_use, manual_slots_in_use, max_trades_per_day, subscription_tier, max_manual_slots = user_data
    ...
    def _build_slot_info(self, concurrent_used: int, daily_used: int, auto_daily_used: int, limits: Dict, action: str) -> Dict:
        ...
        try:
            ...
            with sqlite3.connect('/root/HydraX-v2/bitten.db') as conn:
                ...
                cursor.execute("""
                    ...
                    VALUES (?, ?, ?, 'queued', ?, ?, ?)
                """, (fire_id, sid, uid, idempotency_key,
                     json.dumps(validation['policy_echo']), datetime.now()))
