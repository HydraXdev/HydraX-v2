...
def get_user_risk_profile(user_id):
    ...
    try:
        ...
        return {"risk_percentage": 1.0, "max_daily_risk": 5.0, "max_concurrent_trades": 1, "risk_mode": "CONSERVATIVE"}
...
if __name__ == "__main__":
    ...
    position_size, risk_amount = calculate_position_size(balance, risk_profile["risk_percentage"], sl_pips, symbol)
