...
def create_icon(size, output_path):
    ...
    draw.rectangle(
        [border_width, border_width, size - border_width, size - border_width], outline="#00ff41", width=border_width
    )
    ...
    # Crown base
    draw.rectangle([crown_x, crown_y + crown_size // 2, crown_x + crown_size, crown_y + crown_size], fill="#ff6b00")
