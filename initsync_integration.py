...
class SimpleInitSync:
    ...
    def create_user_session(
        self, telegram_id: int, user_id: str, tier: str, platforms: List[str]
    ...
    def get_tier_config(self, tier: str) -> Dict:
        ...
        configs = {
            "press_pass": {"max_lot_size": 0.01, "max_daily_loss": 50.0, "fire_modes": ["manual"]},
            "nibbler": {"max_lot_size": 0.1, "max_daily_loss": 200.0, "fire_modes": ["manual"]},
            "fang": {"max_lot_size": 0.5, "max_daily_loss": 500.0, "fire_modes": ["manual"]},
            "commander": {
                "max_lot_size": 1.0,
                "max_daily_loss": 1000.0,
                "fire_modes": ["manual", "semi_auto", "full_auto"],
            },
            "apex": {"max_lot_size": 2.0, "max_daily_loss": 2000.0, "fire_modes": ["manual", "semi_auto", "full_auto"]},
        }
...
def initsync_create_user(
    telegram_id: int, user_id: str, tier: str, platforms: List[str]
) -> Tuple[bool, str, Optional[Dict]]:
    """Create new user session"""
...
if __name__ == "__main__":
    ...
    success, result, session_data = initsync_create_user(
        telegram_id=123456789, user_id="test_user_001", tier="fang", platforms=["telegram", "webapp"]
    )
