...
class MissionCache:
    ...
    def __init__(
        ...
        # Cache statistics
        self.stats = {"hits": 0, "misses": 0, "invalidations": 0, "evictions": 0, "total_requests": 0}
    ...
    def _load_mission_from_file(self, mission_id: str) -> Optional[Dict[Any, Any]]:
        ...
        potential_paths = [self.missions_dir / f"mission_{mission_id}.json", self.missions_dir / f"{mission_id}.json"]
...
if __name__ == "__main__":
    ...
    test_mission = {
        ...
        "timing": {"expires_at": (datetime.now() + timedelta(hours=1)).isoformat()},
    }
