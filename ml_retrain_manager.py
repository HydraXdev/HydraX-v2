...
class MLRetrainManager:
    ...
    def update_status_after_retrain(
        self, status: Dict[str, Any], retrain_result: Dict[str, Any], entry_count: int
    ) -> Dict[str, Any]:
    ...
    def run_retrain_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not retrain_check.get("should_retrain", False):
                ...
                return {"retrain_performed": False, "reason": "Criteria not met", "status": status}
            ...
            return {"retrain_performed": False, "error": str(e)}
