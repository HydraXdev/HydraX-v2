//+------------------------------------------------------------------+
//|                           BITTENBridge_TradeExecutor_FIXED.mq5    |
//|                 Fixed Version - No Infinite Loops                 |
//+------------------------------------------------------------------+
#property strict
#property copyright "BITTEN Trading System"
#property version   "3.0"
#property description "Fixed EA with proper file handling and market data streaming"
...
{
    Print("======================================================");
    Print("🔧 BITTENBridge FIXED v3.0 Starting");
    Print("✅ Features: Size check, proper cleanup, market streaming");
    Print("======================================================");
...
void OnTimer()
{
    ...
    if(current_time - last_stream_time >= StreamInterval)
    {
        if(IsMarketOpen())
        {
            ...
            {
                Print("🟢 Market is OPEN - Streaming data");
...
void SendHTTPPost(string url, string json_data)
{
    ...
    headers += "User-Agent: BITTENBridge/3.0\r\n";
...
void OnDeinit(const int reason)
{
    EventKillTimer();
    Print("======================================================");
    Print("🛑 BITTENBridge FIXED EA stopped. Reason: ", reason);
