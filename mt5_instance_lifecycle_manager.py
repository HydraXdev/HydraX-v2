...
class MT5LifecycleManager:
    ...
    def check_replenishment_needed(self):
        ...
        for broker_type, config in self.replenishment_config.items():
            ...
            totals = {"generic_demo": 200, "forex_demo": 25, "forex_live": 100, "coinexx_demo": 10, "coinexx_live": 15}
    ...
    def freeze_user_data(self, user_id):
        ...
        if stats:
            user_data["xp_data"] = {"total": stats[0], "lifetime": stats[1]}
            user_data["trade_stats"] = {"win_rate": stats[2], "total_trades": stats[3]}
        ...
        user_data["achievements"] = [{"id": a[0], "date": a[1], "points": a[2]} for a in achievements]
