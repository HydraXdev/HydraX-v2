...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("/root/HydraX-v2/logs/node_registry.log"), logging.StreamHandler()],
)
        ...
        try:
            ...
            if old_node_data:
                ...
                self.redis_client.hset(
                    f"node:{old_node_id}",
                    mapping={"status": "replaced", "disconnected_at": str(time.time()), "total_uptime": str(uptime)},
                )
        ...
        try:
            ...
            for node in active_nodes:
                ...
                if broker not in broker_stats:
                    broker_stats[broker] = {"nodes": 0, "accounts": set(), "total_balance": 0, "total_equity": 0}
    ...
    def monitor_nodes(self):
        ...
        while self.running:
            try:
                ...
                logger.info(
                    f"📊 Registry Status: {stats.get('active_nodes', 0)} active nodes, "
