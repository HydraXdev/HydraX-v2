...
def calculate_realistic_monthly_performance():
    ...
    expected_value_per_trade = (win_rate * expected_gain_per_winning_trade) + (
        (1 - win_rate) * -expected_loss_per_losing_trade
    )
    ...
    for scenario_name, scenario_win_rate in scenarios.items():
        scenario_expected_value = (scenario_win_rate * expected_gain_per_winning_trade) + (
            (1 - scenario_win_rate) * -expected_loss_per_losing_trade
        )
