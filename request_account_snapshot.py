...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Request fresh account snapshot from EA'
    )
    parser.add_argument('--account', type=str,
                       help='Account ID to request snapshot from')
    parser.add_argument('--all', action='store_true',
                       help='Request snapshots from all connected EAs')
    parser.add_argument('--host', type=str, default='127.0.0.1',
                       help='HydraSocket router host (default: 127.0.0.1)')
    parser.add_argument('--port', type=int, default=5555,
                       help='HydraSocket command port (default: 5555)')
