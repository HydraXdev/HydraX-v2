...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("/root/HydraX-v2/mt5_validation.log"), logging.StreamHandler()],
)
...
class MT5ServerValidator:
    ...
    def validate_server_connection(self, server_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {"success": False, "server": server_name, "error": str(e), "timestamp": datetime.now().isoformat()}
