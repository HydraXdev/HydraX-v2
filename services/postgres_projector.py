...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/root/HydraX-v2/logs/postgres_projector.log'),
...
def main():
    ...
    parser.add_argument('--backfill', action='store_true', 
                        help='Backfill existing data before starting real-time processing')
