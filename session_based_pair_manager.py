...
class SessionBasedPairManager:
        ...
        return [
            ...
            TradingSession(
                ...
                pairs=[
                    ...
                    "NZDJPY",
                    "AUDUSD",
                    "NZDUSD",  # Also active during Asian session
                ],
            ...
            TradingSession(
                ...
                pairs=["EURUSD", "GBPUSD", "EURGBP", "EURAUD", "USDCHF", "EURJPY", "GBPJPY"],
            ...
            TradingSession(
                ...
                pairs=["EURUSD", "GBPUSD", "USDJPY", "USDCAD", "AUDUSD", "NZDUSD", "USDCHF"],
                boost_multiplier=2.0,
            ),
    ...
    def create_session_config(self) -> Dict:
        ...
        config = {
            ...
            "session_boosts": {"LONDON": 2, "NY": 2, "OVERLAP": 3, "ASIAN": 1, "OTHER": 0},
        }
