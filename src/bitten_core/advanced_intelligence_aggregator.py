...
from bitten_core.intelligence_aggregator import FundamentalAnalyzer, SentimentAnalyzer, TechnicalAnalyzer

# Import core components
from bitten_core.signal_fusion import FusedSignal, IntelSource, SignalFusionEngine
    ...
    async def analyze(self, pair: str, market_data: Dict) -> Optional[IntelSource]:
        ...
        try:
            ...
            return IntelSource(
                ...
                metadata={"scores": scores, "buy_pressure": buy_pressure, "sell_pressure": sell_pressure},
            )
...
class AdvancedSentimentIntelligence:
    ...
    async def _get_news_sentiment(self, pair: str) -> Dict:
        ...
        try:
            ...
            return {"direction": "bullish", "confidence": 75, "articles_analyzed": 10}
        except Exception as e:
    ...
    async def _get_twitter_sentiment(self, pair: str) -> Dict:
        ...
        try:
            ...
            # For now, return mock data
            return {"direction": "bearish", "confidence": 65, "tweets_analyzed": 100}
        except Exception as e:
    ...
    async def _get_options_sentiment(self, pair: str) -> Dict:
        ...
        try:
            ...
            # For now, return mock data
            return {"direction": "bullish", "confidence": 80, "flow_analyzed": 50}
        except Exception as e:
