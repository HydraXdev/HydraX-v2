...
class AutoCleanupSystem:
    ...
    def delete_telegram_message(self, bot_name: str, chat_id: str, message_id: int) -> bool:
        ...
        try:
            response = requests.post(url, json={"chat_id": chat_id, "message_id": message_id}, timeout=5)
                    ...
                    try:
                        ...
                        if current_time >= delete_at:
                            ...
                            if self.delete_telegram_message(
                                message_data["bot"], message_data["chat_id"], message_data["message_id"]
                            ):
                                deleted_count += 1
    ...
    def log_cleanup_stats(self):
        ...
        try:
            ...
            logger.info(
                f"Storage stats - Missions: {mission_count} files ({mission_size/1024:.1f}KB), "
