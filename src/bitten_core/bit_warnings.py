...
class BitWarningSystem:
    ...
    def record_confirmation_response(self, user_id: str, tcs: float, warning_level: WarningLevel, action: str):
...
def process_warning_response(user_id: str, tcs: float, action: str) -> Dict:
    ...
    proceed = action in ["confirm_extreme", "confirm_high", "confirm_moderate", "confirm_low", "override_warning"]
