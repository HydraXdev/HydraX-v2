...
from .chat_notifications import ChatNotificationService, NotificationPriority, NotificationType
from .security_utils import SecurityUtils  # Assuming this exists
from .squad_chat import ChatUser, SquadChatSystem, UserRole
...
class ChatIntegration:
    ...
    def __init__(
        self, app: Flask, user_profile_manager=None, tier_lock_manager=None, squad_radar=None, security_utils=None
    ):
        self.app = app
    ...
    def _initialize_chat_systems(self):
        ...
        try:
            ...
            self.chat_system = SquadChatSystem(
                app=self.app, redis_url=self.config.get("redis_url", "redis://localhost:6379")
            )
    ...
    def _register_flask_routes(self):
        ...
        def upload_file():
            ...
            try:
                ...
                return jsonify({"status": "success", "file_url": file_url, "filename": file.filename})
        ...
        def mark_notifications_read():
            ...
            try:
                ...
                self.notification_service.mark_notifications_read(user_id, notification_ids)
        ...
        def chat_settings():
            ...
            try:
                ...
                if request.method == "GET":
                    ...
                    # Update settings
                    self.notification_service.update_user_settings(user_id=user_id, **data)
            ...
            def on_squad_activity(activity_data):
                try:
                    ...
                    self.chat_system.send_system_message(
                        ...
                        metadata={"type": "squad_activity", "activity_data": activity_data},
                    )
            ...
            def on_achievement_earned(achievement_data):
                try:
                    ...
                    self.chat_system.send_system_message(
                        ...
                        metadata={"type": "achievement", "achievement_data": achievement_data},
                    )
