...
class CryptoPositionSizer:
    ...
    def calculate_crypto_position_size_atr(
        self,
        account_balance: float,
        symbol: str,
        entry_price: float,
...
class CryptoFirePacketBuilder:
    ...
    def build_crypto_fire_packet(
        self, signal_data: Dict, user_profile: Dict, account_balance: float = 10000.0
    ) -> Optional[CryptoTradePacket]:
...
def build_crypto_fire_packet(
    signal_data: Dict, user_profile: Dict, account_balance: float = 10000.0
) -> Optional[CryptoTradePacket]:
...
if __name__ == "__main__":
    ...
    test_user = {"tier": "NIBBLER", "risk_percent": 2.0}
