...
class DailyDrillReportSystem:
        ...
        try:
            ...
            """,
                (
                    ...
                    stats.wins,
                    stats.losses,
                    stats.net_pnl_percent,
                    stats.strategy_used,
                    stats.xp_gained,
                    stats.shots_remaining,
                    stats.max_shots,
    ...
    def _get_daily_stats(self, user_id: str, date: str) -> Optional[DailyTradingStats]:
        ...
        return DailyTradingStats(
            ...
            wins=row[3],
            losses=row[4],
            net_pnl_percent=row[5],
            strategy_used=row[6],
            xp_gained=row[7],
            shots_remaining=row[8],
            max_shots=row[9],
            consecutive_wins=row[10],
            consecutive_losses=row[11],
            best_trade_pnl=row[12],
            worst_trade_pnl=row[13],
            total_pips=row[14],
        )
    ...
    def _build_stats_summary(self, stats: DailyTradingStats) -> str:
        ...
        strategy_emoji = {"LONE_WOLF": "🐺", "FIRST_BLOOD": "🎯", "DOUBLE_TAP": "💥", "TACTICAL_COMMAND": "⚡"}
