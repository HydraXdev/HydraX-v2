...
class EmergencyStopController:
    ...
    def _validate_state_structure(self, data: Dict) -> Dict:
        ...
        validated_state["last_recovery"] = (
            data.get("last_recovery") if isinstance(data.get("last_recovery"), str) else None
        )
    ...
    def _validate_event_data(self, event_data: Dict) -> Dict:
        ...
        validated["timestamp"] = (
            event_data.get("timestamp") if isinstance(event_data.get("timestamp"), str) else datetime.now().isoformat()
        )
    ...
    def trigger_emergency_stop(
        ...
        try:
            ...
            return {"success": False, "message": f"Emergency stop failed: {str(e)}", "error": str(e)}
    ...
    def recover_from_emergency(self, user_id: Optional[int] = None, force: bool = False) -> Dict[str, Any]:
        ...
        try:
            if not self.is_active():
                return {"success": False, "message": "No emergency stop is currently active"}

            current_event = self.get_current_event()
            if not current_event:
                return {"success": False, "message": "No current emergency event found"}
            ...
            return {"success": False, "message": f"Recovery failed: {str(e)}", "error": str(e)}
    ...
    def _perform_health_check(self) -> Dict[str, Any]:
        ...
        health = {"timestamp": datetime.now().isoformat(), "components": {}, "overall_status": "healthy"}
    ...
    def get_emergency_status(self, user_id: int = None) -> Dict[str, Any]:
        ...
        status = {"is_active": self.is_active(), "timestamp": datetime.now().isoformat()}
    ...
    def _send_emergency_notifications(
        self, event: EmergencyStopEvent, execution_results: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            notification_result = self.notification_system.send_emergency_notification(
                event=event, affected_users=self.state.get("affected_users", []), additional_data=additional_data
            )
