...
from .recovery_strategies import (
    recover_database_issues,
    recover_network_issues,
    recover_system_issues,
    recover_telegram_issues,
    recover_webapp_issues,
    recovery_manager,
)
from .system_monitor import force_monitoring_check, get_monitoring_status, start_system_monitoring, system_monitor
...
class IntegratedErrorSystem:
    ...
    def _setup_integrations(self):
        ...
        self.error_handler.recovery_registry.register_strategy(
            "NETWORK_TIMEOUT", lambda context: recover_network_issues().get("success", False)
        )
        ...
        self.error_handler.recovery_registry.register_strategy(
            "WEBAPP_SERVER_ERROR", lambda context: recover_webapp_issues().get("success", False)
        )
    ...
    def get_comprehensive_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "subsystems": {
                    "error_handling": {"status": "active", "stats": error_stats, "score": error_score},
                    "recovery_system": {"status": "active", "info": recovery_status, "score": recovery_score},
                    "monitoring": {
            ...
            return {"timestamp": datetime.now().isoformat(), "overall_score": 0, "status": "error", "error": str(e)}
    ...
    def run_system_diagnostics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            diagnostics["overall_health"] = (
                ...
                else "fair" if len(diagnostics["issues_found"]) <= 2 else "poor"
            )
    ...
    def _test_database_connectivity(self) -> Dict[str, Any]:
        ...
        try:
            ...
            db_paths = ["data/engagement.db", "data/battle_pass.db", "data/error_tracking.db"]
