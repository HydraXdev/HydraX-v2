...
from .ai_trading_coach import AITradingCoach, get_ai_coach

# Import existing fire router
from .fire_router import ExecutionMode, FireRouter, TradeExecutionResult, TradeRequest
from .institutional_intelligence import InstitutionalIntelligence, get_institutional_intelligence
...
class EnhancedFireRouter(FireRouter):
    ...
    def execute_trade_request_with_ai(
        self, request: TradeRequest, user_profile: Optional[Dict] = None
    ) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            "learning_insights": self._generate_learning_insights(request, coaching_analysis, institutional_analysis),
            "execution_metadata": {
                "ai_enhanced": True,
    ...
    def _make_ai_enhanced_decision(
        self, request: TradeRequest, coaching_analysis: Dict, institutional_analysis: Dict
    ) -> Dict[str, Any]:
            ...
            decision.update(
                {
                    ...
                    "intervention_message": psych_state.get(
                        "intervention_message", "Psychological intervention required"
                    ),
    ...
    def _create_intervention_response(
        self, request: TradeRequest, ai_decision: Dict, coaching_analysis: Dict
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "execution_metadata": {"ai_enhanced": True, "intervention_applied": True, "blocked_by_ai": True},
        }
    ...
    def _generate_enhanced_recommendations(self, coaching_analysis: Dict, institutional_analysis: Dict) -> List[str]:
    ...
    def get_enhanced_system_status(self) -> Dict[str, Any]:
        ...
        ai_metrics = {
            ...
            "ai_performance": {
                "intervention_rate": (
                    self.ai_stats["interventions_triggered"] / max(self.ai_stats["trades_analyzed"], 1)
                )
                * 100,
                "psychological_intervention_rate": (
                    self.ai_stats["psychological_blocks"] / max(self.ai_stats["trades_analyzed"], 1)
                )
                * 100,
                "risk_reduction_rate": (self.ai_stats["risk_reductions"] / max(self.ai_stats["trades_analyzed"], 1))
                * 100,
            },
        }
