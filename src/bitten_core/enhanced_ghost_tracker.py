...
class EnhancedGhostTracker:
    ...
    def get_recent_ghost_activity(self, hours_back: int = 24) -> Dict:
        ...
        return {
            ...
            "stealth_assessment": (
                "Excellent" if avg_effectiveness > 0.8 else "Good" if avg_effectiveness > 0.6 else "Needs Improvement"
            ),
        }
    ...
    def _check_tp_sl_hits(
        self, direction: str, entry_price: float, take_profit: float, stop_loss: float, price_data: List[Dict]
    ...
    def get_missed_win_summary(self, hours_back: int = 24) -> Dict:
        ...
        try:
            ...
            return {
                ...
                "top_missed_symbol": (
                    {"symbol": top_missed_symbol[0], "count": top_missed_symbol[1]} if top_missed_symbol else None
                ),
            }
