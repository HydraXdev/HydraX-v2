...
class EventScheduler:
    ...
    async def _schedule_weekend_warriors(self, start_date: datetime):
        ...
        for day_offset in [0, 1]:
            ...
            event = Event(
                ...
                metadata={"auto_scheduled": True, "bonus_signals": 5, "signal_quality_boost": 1.2},
            )
    ...
    async def _schedule_study_sundays(self, start_date: datetime):
        ...
        event = Event(
            ...
            metadata={"auto_scheduled": True, "bonus_courses": ["advanced_ta", "risk_management"]},
        )
    ...
    def get_upcoming_events(self, hours: int = 24) -> List[Event]:
        ...
        upcoming = [
            ...
            if event.status == EventStatus.SCHEDULED and event.start_time <= cutoff_time
        ]
...
class EventManager:
    ...
    def record_event_participation(self, event_id: str, user_id: str, metrics: Dict[str, Any]):
        ...
        if event_id not in self.event_stats:
            self.event_stats[event_id] = {"participants": set(), "total_xp_earned": 0, "total_trades": 0, "metrics": {}}
