...
NEWS_EVENT_SCHEMA = {
    "type": "object",
    "properties": {
        "date": {"type": "string", "pattern": "^\\d{4}-\\d{2}-\\d{2}$", "maxLength": 10},
        "time": {"type": "string", "maxLength": 20},
        "country": {"type": "string", "pattern": "^[A-Z]{3}$", "maxLength": 3},
        "impact": {"type": "string", "maxLength": 20},
        "title": {"type": "string", "maxLength": 200},
        "forecast": {"type": ["string", "null"], "maxLength": 50},
        "previous": {"type": ["string", "null"], "maxLength": 50},
        "actual": {"type": ["string", "null"], "maxLength": 50},
    },
