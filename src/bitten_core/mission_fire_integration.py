...
class MissionFireIntegration:
    ...
    def fire_mission(self, mission_briefing, user_id: str) -> Dict:
        ...
        try:
            ...
            fire_request = {"user_id": user_id, "signal": apex_signal}
            ...
            response = self.session.post(
                f"{self.toc_url}/fire", json=fire_request, headers={"Content-Type": "application/json"}
            )
    ...
    def assign_user_clone(self, user_id: str, broker_type: str = "demo") -> Dict:
        ...
        try:
            request_data = {"user_id": user_id, "broker_type": broker_type}

            response = self.session.post(
                f"{self.toc_url}/assign-terminal", json=request_data, headers={"Content-Type": "application/json"}
            )
