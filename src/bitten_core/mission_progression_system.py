...
try:
    ...
    from .tactical_mission_framework import MissionPhase, OperationType, TacticalMissionFramework
except ImportError:
...
class MissionProgressionSystem:
        ...
        return {
            ...
            OperatorRank.GENERAL: {
                ...
                "special_requirements": [
                    "legendary_mission_success",
                    "community_leadership",
                    "norman_legacy_fulfilled",
                ],
            },
        }
    ...
    def _check_rank_advancement(self, profile: OperatorProfile) -> Optional[Dict]:
        ...
        # Check requirements
        if (
            profile.missions_completed >= requirements.get("missions_required", 0)
            and profile.mission_success_rate >= requirements.get("success_rate_required", 0)
            and profile.total_experience >= requirements.get("experience_required", 0)
        ):
    ...
    def _unlock_rank_benefits(self, profile: OperatorProfile, new_rank: OperatorRank) -> None:
        ...
        rank_benefits = {
            ...
            OperatorRank.COLONEL: {"mission_types": [], "max_difficulty": MissionDifficulty.LEGENDARY},
        }
    ...
    def _update_story_progression(self, profile: OperatorProfile, template: MissionTemplate, results: Dict) -> Dict:
        ...
        if norman_story_engine:
            ...
            norman_story_engine.update_user_progress(
                profile.user_id,
                {
