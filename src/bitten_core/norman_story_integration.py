...
class NormanStoryEngine:
    ...
    def enhance_mission_briefing(self, briefing_data: Dict, user_id: str) -> Dict:
        ...
        if context.current_phase in [StoryPhase.EARLY_STRUGGLE, StoryPhase.AWAKENING]:
            ...
            enhanced_briefing["encouragement"] = (
                "Every master was once a beginner. Norman's journey started just like this."
            )
            ...
            enhanced_briefing["regional_touch"] = random.choice(
                self.story_database["mississippi_culture"]["delta_wisdom"]
            )
            ...
            enhanced_briefing["community_message"] = (
                "Your success lifts others. Norman's vision lives through traders like you."
            )
