...
class NotebookMissionIntegration:
    ...
    def add_mission_note(self, mission_id: str, symbol: str, note_content: str, note_type: str = "trade_plan") -> Dict:
...
def create_note_from_mission(user_id: str, mission_id: str, symbol: str, note_type: str, content: str) -> Dict:
