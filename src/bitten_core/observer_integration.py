...
class ObserverIntegration:
    ...
    async def _generate_random_event(self) -> Optional[ObserverEvent]:
        ...
        event_types = [("market_comment", 0.4), ("random_appearance", 0.6)]
        ...
        return ObserverEvent(event_type=event_type, data=data, timestamp=datetime.now(), priority=5)
    ...
    def _get_milestone_message(self, milestone_type: str, data: Dict) -> str:
        ...
        category_messages = messages.get(
            milestone_type,
            [
...
if __name__ == "__main__":
    ...
    async def run_example():
        ...
        # Trade completed
        await integration.on_trade_completed({"profit": 250, "risk_reward_ratio": 4.2, "hold_time_minutes": 35})
