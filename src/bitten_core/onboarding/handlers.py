...
class OnboardingHandlers:
    ...
    async def handle_input(self, session, current_state, input_type: str, input_data: Any) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"error": False, "message": "Processing...", "advance_state": True}

        except Exception as e:
            logger.error(f"Handler error in {current_state.value}: {str(e)}")
            return {"error": True, "message": self.friendly_errors["technical_error"], "advance_state": False}
    ...
    async def _handle_first_contact(self, session, input_type: str, input_data: Any) -> Dict[str, Any]:
        ...
        if input_type == "callback":
            ...
            if text_lower in self.yes_variations:
                ...
                return {"error": True, "message": self.friendly_errors["need_selection"], "advance_state": False}
    ...
    async def _handle_oath_of_enlistment(self, session, input_type: str, input_data: Any) -> Dict[str, Any]:
        ...
        if input_type == "callback":
            if input_data == "accept_oath":
                ...
                return {"error": False, "message": oath_text, "advance_state": False}
        ...
        if input_type == "callback":
            if input_data == "activate_press_pass":
                ...
                return {
                    ...
                    "message": message,
                    "advance_state": True,
                    "state_data": {"is_press_pass": True, "press_pass_expiry": session.press_pass_expiry.isoformat()},
                }
    ...
    async def _handle_callsign_creation(self, session, input_type: str, input_data: Any) -> Dict[str, Any]:
        ...
        if input_type == "text":
            ...
            if len(callsign) > 15:
                return {"error": True, "message": self.friendly_errors["too_long"], "advance_state": False}
...
Everything look good?"""
                ...
                return {"error": False, "message": summary, "advance_state": False, "show_ready_button": True}
