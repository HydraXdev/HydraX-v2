...
from ..database.connection import DatabaseSession, get_async_db, get_db_connection
...
class PressPassManager:
    ...
    async def provision_demo_account(self, user_id: str, real_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": str(e), "message": "Failed to provision demo account. Please try again."}
    ...
    async def check_press_pass_expiry(self, user_id: str, expiry_date: datetime) -> Dict[str, Any]:
        ...
        return {
            "expired": False,
            "remaining_time": {"days": days, "hours": hours, "total_hours": remaining.total_seconds() / 3600},
        ...
        try:
            async with get_async_db() as conn:
                ...
                if current_xp is None:
                    return {"success": False, "error": "User not found in Press Pass system"}
    ...
    async def send_expiry_reminder(self, user_id: str, days_remaining: int) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"sent": True, "message": message, "days_remaining": days_remaining}
    ...
    async def upgrade_to_paid_tier(self, user_id: str, new_tier: str) -> Dict[str, Any]:
        ...
        try:
            async with get_async_db() as conn:
                ...
                logger.info(
                    f"Upgraded Press Pass user {user_id} to {new_tier}. XP preserved: {current_xp} + {self.enlistment_bonus_xp} bonus = {final_xp}"
                )
            ...
            return {"success": False, "error": str(e), "message": "Upgrade failed. Please try again."}
