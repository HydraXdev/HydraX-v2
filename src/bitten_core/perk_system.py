...
class PerkTier(Enum):
    ...
    def min_level(self) -> int:
        ...
        tier_levels = {PerkTier.BASIC: 1, PerkTier.ADVANCED: 21, PerkTier.ELITE: 51, PerkTier.LEGENDARY: 101}
        return tier_levels[self]

    @property
    def point_cost(self) -> int:
        """Get point cost for perks in this tier"""
        tier_costs = {PerkTier.BASIC: 1, PerkTier.ADVANCED: 2, PerkTier.ELITE: 3, PerkTier.LEGENDARY: 5}
...
class PerkSystem:
    ...
    def _initialize_perk_catalog(self) -> Dict[str, Perk]:
        ...
        catalog["reduced_fees_1"] = Perk(
            ...
            effects=[PerkEffect("fee_reduction", 0.10, "-10% trading fees")],
            max_rank=3,
        )
        ...
        catalog["better_spreads_1"] = Perk(
            ...
            tier=PerkTier.BASIC,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("spread_improvement", 0.05, "+5% spread improvement")],
        )
        ...
        catalog["quick_fingers"] = Perk(
            ...
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("execution_speed", 2.0, "2x faster execution")],
        ...
        catalog["risk_shield"] = Perk(
            ...
            effects=[PerkEffect("loss_reduction", 0.50, "-50% on first daily loss")],
            xp_requirement=5000,
        )
        ...
        catalog["ghost_trades"] = Perk(
            ...
            effects=[PerkEffect("trade_privacy", 1.0, "Trades hidden from radar")],
            elite_only=True,
        )
        ...
        catalog["double_tap"] = Perk(
            ...
            tier=PerkTier.ELITE,
            perk_type=PerkType.ACTIVE,
            effects=[PerkEffect("signal_reuse", 1.0, "Reuse signals after 30min")],
        ...
        catalog["market_oracle"] = Perk(
            ...
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("early_insight", 1.0, "1hr early win probability")],
        ...
        catalog["priority_signals"] = Perk(
            ...
            tier=PerkTier.BASIC,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("signal_priority", 30, "30s early signal access")],
        )
        ...
        catalog["enhanced_indicators"] = Perk(
            ...
            tier=PerkTier.BASIC,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("extra_indicators", 3, "+3 technical indicators")],
        )
        ...
        catalog["pattern_recognition"] = Perk(
            ...
            tier=PerkTier.ADVANCED,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("pattern_analysis", 1.0, "Historical pattern matching")],
        ...
        catalog["volatility_radar"] = Perk(
            ...
            tier=PerkTier.ADVANCED,
            perk_type=PerkType.ACTIVE,
            effects=[PerkEffect("volatility_alerts", 1.0, "Live volatility tracking")],
        ...
        catalog["quantum_analysis"] = Perk(
            ...
            tier=PerkTier.ELITE,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("confluence_score", 1.0, "MTF confluence analysis")],
        ...
        catalog["prophet_mode"] = Perk(
            ...
            tier=PerkTier.LEGENDARY,
            perk_type=PerkType.ACTIVE,
            effects=[PerkEffect("signal_prediction", 3, "Predict next 3 signals")],
        ...
        catalog["squad_synergy"] = Perk(
            ...
            tier=PerkTier.BASIC,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("squad_xp_bonus", 0.05, "+5% XP from squad wins")],
            max_rank=3,
        )
        ...
        catalog["mentor_bonus"] = Perk(
            ...
            tier=PerkTier.BASIC,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("recruit_xp_bonus", 0.10, "+10% XP from recruits")],
        )
        ...
        catalog["rally_cry"] = Perk(
            ...
            tier=PerkTier.ADVANCED,
            perk_type=PerkType.ACTIVE,
            effects=[PerkEffect("squad_boost", 0.10, "+10% squad trade boost")],
        ...
        catalog["trade_sharing"] = Perk(
            ...
            tier=PerkTier.ADVANCED,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("instant_share", 1.0, "Instant trade sharing")],
        ...
        catalog["squad_leader"] = Perk(
            ...
            tier=PerkTier.ELITE,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("squad_reward_share", 0.20, "Share 20% win bonus")],
        ...
        catalog["legacy_builder"] = Perk(
            ...
            tier=PerkTier.LEGENDARY,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("recruit_boost", 5, "Recruits start level 5")],
        ...
        catalog["xp_boost_1"] = Perk(
            ...
            tier=PerkTier.BASIC,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("xp_multiplier", 0.15, "+15% XP gain")],
            max_rank=3,
        )
        ...
        catalog["reward_hunter"] = Perk(
            ...
            tier=PerkTier.BASIC,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("reward_multiplier", 0.10, "+10% rewards")],
        )
        ...
        catalog["compound_interest"] = Perk(
            ...
            tier=PerkTier.ADVANCED,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("streak_multiplier", 2.0, "2x streak progression")],
        ...
        catalog["daily_compound"] = Perk(
            ...
            tier=PerkTier.ADVANCED,
            perk_type=PerkType.TRIGGERED,
            effects=[PerkEffect("xp_interest", 0.05, "+5% on yesterday's XP")],
        ...
        catalog["prestige_master"] = Perk(
            ...
            tier=PerkTier.ELITE,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("prestige_retention", 0.25, "Keep 25% XP on prestige")],
            elite_only=True,
        )
        ...
        catalog["infinite_wealth"] = Perk(
            ...
            tier=PerkTier.LEGENDARY,
            perk_type=PerkType.PASSIVE,
            effects=[PerkEffect("passive_xp", 100, "100 XP/hour passive income")],
        ...
        catalog["winter_warrior"] = Perk(
            ...
            effects=[PerkEffect("seasonal_xp", 0.50, "+50% winter XP")],
        ...
        catalog["halloween_hunter"] = Perk(
            ...
            tier=PerkTier.BASIC,
            perk_type=PerkType.SEASONAL,
            effects=[PerkEffect("spooky_bonus", 2.0, "2x rewards on Halloween")],
    ...
    def get_player_data(self, user_id: int) -> PlayerPerkData:
        ...
        if not row:
            ...
            player_data = PlayerPerkData(
                user_id=user_id, level=1, available_points=1, spent_points=0, unlocked_perks={}  # Start with 1 point
            )
    ...
    def unlock_perk(
        self, user_id: int, perk_id: str, user_xp: int = 0, user_achievements: List[str] = None
    ) -> Tuple[bool, str]:
    ...
    def create_loadout(self, user_id: int, name: str, perks: Dict[PerkBranch, str]) -> Tuple[bool, str]:
    ...
    def get_active_effects(self, user_id: int) -> Dict[str, List[PerkEffect]]:
        ...
        if synergy_bonus > 0:
            effects["synergy_bonus"] = [
                PerkEffect("global_bonus", synergy_bonus, f"+{int(synergy_bonus * 100)}% synergy bonus")
            ]
    ...
    def get_perk_tree_display(self, user_id: int) -> Dict[str, Any]:
        ...
        for perk_id, perk in self.perk_catalog.items():
            ...
            perk_info = {
                ...
                "requirements": {"xp": perk.xp_requirement, "achievement": perk.achievement_requirement},
        ...
        return {
            ...
            "player": {
                ...
                "loadouts": [
                    {"id": l.loadout_id, "name": l.name, "perks": l.active_perks} for l in player_data.loadouts
                ],
                "respec_count": player_data.respec_count,
                "can_respec": player_data.last_respec is None
                or (datetime.now() - player_data.last_respec).total_seconds() > self.RESPEC_COOLDOWN_HOURS * 3600,
            },
        }
    ...
    def get_perk_recommendations(self, user_id: int, user_stats: Dict[str, Any]) -> List[Dict]:
        ...
        if squad_size > 5 and "squad_synergy" not in player_data.unlocked_perks:
            recommendations.append(
                {"perk_id": "squad_synergy", "reason": "Large squad = more XP opportunities", "priority": "medium"}
            )
    ...
    def apply_perk_effects(self, user_id: int, context: str, base_value: float) -> Tuple[float, List[str]]:
