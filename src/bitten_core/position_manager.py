...
from .fire_modes import TIER_CONFIGS, TierLevel
...
class PositionManager:
    ...
    def can_open_position(self, user_id: int, tier: TierLevel, balance: float, signal_type: str) -> Tuple[bool, str]:
        """
    ...
    def _get_minimum_balance(self, tier: TierLevel) -> float:
        ...
        min_balances = {TierLevel.NIBBLER: 500, TierLevel.FANG: 500, TierLevel.COMMANDER: 1000}
    ...
    def get_user_status(self, user_id: int) -> Dict:
        ...
        return {
            ...
            "position_details": [
                {"id": p.position_id, "symbol": p.symbol, "type": p.position_type, "risk": p.risk_amount}
                for p in positions
            ],
            "daily_risk_used": self.daily_risk.get(user_id, 0),
            "total_exposure": self._calculate_total_exposure(user_id),
