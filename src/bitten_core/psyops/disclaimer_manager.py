...
"""
    ...
    def get_onboarding_disclaimer(self) -> Dict:
        ...
        return {
            ...
            "options": {
                "accept": {"text": "✅ I understand and accept", "action": "accept_disclaimer"},
                "decline": {"text": "❌ I do not accept", "action": "exit_onboarding"},
            },
            "additional_controls": {
                "bot_toggle": {
            ...
            "sections": [
                ...
                },
                {
                    ...
                    "controls": [
                        ...
                        {"type": "button", "label": "📄 View Full Disclaimer", "action": "show_disclaimer"},
                    ],
                },
            ],
        }
    ...
    def toggle_all_bots(self, user_id: str, enabled: bool) -> Dict:
        ...
        return {"success": True, "bots_enabled": enabled, "message": f"All bots {'enabled' if enabled else 'disabled'}"}
    ...
    def toggle_individual_bot(self, user_id: str, bot_name: str, enabled: bool) -> Dict:
        ...
        if not consent.bots_enabled:
            return {"error": "Cannot toggle individual bot", "message": "Enable all bots first"}
    ...
    def set_immersion_level(self, user_id: str, level: str) -> Dict:
        ...
        adjustments = {
            ...
            "moderate": {"message": "Balanced experience selected.", "bot_intensity": 0.7, "stress_multiplier": 1.0},
            "minimal": {
        ...
        return {"success": True, "immersion_level": level, "message": adjustment["message"], "adjustments": adjustment}
    ...
    def format_bot_control_buttons(self) -> Dict:
        ...
        return {
            "inline_keyboard": [
                [
                    {"text": "🤖 Bot Settings", "callback_data": "settings_bots"},
                    {"text": "🎮 Immersion", "callback_data": "settings_immersion"},
                ],
                [{"text": "📄 View Disclaimer", "callback_data": "show_disclaimer"}],
            ]
        }
