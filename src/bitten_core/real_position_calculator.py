...
class RealPositionCalculator:
    ...
    def calculate_real_position_size(
        self, account_balance: float, risk_percentage: float, stop_loss_pips: int, symbol: str, tier: str
    ) -> Dict:
        """
...
def calculate_real_position_size(
    account_balance: float, risk_percentage: float, stop_loss_pips: int, symbol: str, tier: str
) -> Dict:
    """Main entry point for real position calculation"""
    calculator = get_position_calculator()
    return calculator.calculate_real_position_size(account_balance, risk_percentage, stop_loss_pips, symbol, tier)
...
if __name__ == "__main__":
    ...
    test_calculation = calculator.calculate_real_position_size(
        account_balance=5000.0, risk_percentage=2.0, stop_loss_pips=20, symbol="EURUSD", tier="NIBBLER"
    )
