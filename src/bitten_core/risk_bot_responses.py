...
class RiskBotResponses:
    ...
    def get_risk_mode_change_response(old_mode: str, new_mode: str, risk_percent: float) -> Dict[str, str]:
        ...
        if new_mode in ["boost", "high_risk"]:
            return {
                ...
                "drillbot": f"WEAPONS FREE! {risk_percent}% RISK AUTHORIZED. " f"DON'T MAKE ME REGRET THIS, SOLDIER!",
    ...
    def get_drawdown_warning_response(current_drawdown: float, limit: float) -> Dict[str, str]:
        ...
        if percent_to_limit >= 80:
            ...
            return {
                ...
                "medicbot": f"Minor wounds detected. -{current_drawdown:.1f}% is manageable, " f"but stay vigilant.",
    ...
    def get_recovery_response(recovery_type: str) -> Dict[str, str]:
        ...
        if recovery_type == "xp_positive":
            ...
            return {
                ...
                "medicbot": "Your recovery time is over. Remember what you learned " "and trade with discipline.",
    ...
    def format_telegram_message(
        event: RiskEvent, bot_responses: Dict[str, str], primary_bot: str = "overwatchbot"
    ) -> str:
