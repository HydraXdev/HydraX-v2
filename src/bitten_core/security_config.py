...
class SecurityMonitor:
    ...
    def detect_anomalies(self) -> List[Dict[str, Any]]:
        ...
        recent_emergencies = [
            ...
            if e["type"] == "emergency_command" and datetime.fromisoformat(e["timestamp"]) > recent_threshold
        ]
        ...
        failed_auths = [
            e
            for e in self.security_events
            if e["type"] == "authentication_failure" and datetime.fromisoformat(e["timestamp"]) > recent_threshold
        ]
