...
class SignalAlerts:
    ...
    def send_alert(self, alert_data: Dict[str, Any]) -> bool:
        """Mock send alert"""
        self.alerts.append({"timestamp": datetime.now().isoformat(), "data": alert_data})
...
def send_signal_alert(alert_type: str, message: str, data: Dict[str, Any] = None) -> bool:
    """Send a signal alert"""
    alert_data = {"type": alert_type, "message": message, "data": data or {}, "timestamp": datetime.now().isoformat()}
