...
class SocialBragIntegration:
    ...
    def notify_rank_promotion(self, user_id: str, username: str, new_rank: str, old_rank: str):
        ...
        try:
            if self.social_brag_system:
                return self.social_brag_system.notify_rank_promotion(user_id, username, new_rank, old_rank)
        except Exception as e:
    ...
    def notify_prestige_achievement(self, user_id: str, username: str, prestige_level: int):
        ...
        try:
            if self.social_brag_system:
                return self.social_brag_system.notify_prestige_achievement(user_id, username, prestige_level)
        except Exception as e:
...
def setup_bitten_social_brags(
    xp_economy, referral_system, notification_handler, chat_notification_service, user_manager=None
):
    """
...
if __name__ == "__main__":
    ...
    class MockUserManager:
        def get_username(self, user_id: str) -> str:
            callsigns = {"user123": "ALPHA-1", "user456": "BRAVO-2", "user789": "CHARLIE-3"}
