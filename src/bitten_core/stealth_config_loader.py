...
class StealthConfigLoader:
    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        return {
            "stealth": {
                ...
                "ghost_skip": {"low": 0.05, "medium": 0.167, "high": 0.25, "ghost": 0.33},
                "volume_cap": {"max_per_asset": 3, "max_total": 10},
            }
        }
    ...
    def get_tier_permissions(self, tier: str) -> Dict[str, Any]:
        ...
        return tier_settings.get(tier.lower(), {"enabled": False, "max_level": "off"})
