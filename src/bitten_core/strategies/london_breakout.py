...
class LondonBreakoutStrategy(StrategyBase):
    ...
    def analyze_setup(self, market_data: List[MarketData], indicators: TechnicalIndicators) -> Optional[TradingSignal]:
        ...
        stop_loss, take_profit = self._calculate_targets(entry_price, direction, range_high, range_low, indicators.atr)
        ...
        tcs_factors = self._calculate_london_tcs_factors(current_data, indicators, range_pips, confidence_factors)
    ...
    def _detect_breakout(
        self, current_data: MarketData, range_high: float, range_low: float, indicators: TechnicalIndicators
    ) -> Optional[Tuple[SignalDirection, float, List[str], List[str]]]:
        """
    ...
    def _calculate_targets(
        self, entry_price: float, direction: SignalDirection, range_high: float, range_low: float, atr: float
    ) -> Tuple[float, float]:
        """
    ...
    def _calculate_london_tcs_factors(
        self,
