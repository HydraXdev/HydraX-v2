...
class MarketAnalyzer:
    ...
    def update_market_data(self, market_data: MarketData) -> None:
        ...
        if self.last_level_update is None or market_data.timestamp - self.last_level_update > timedelta(hours=1):
    ...
    def _update_key_levels(self) -> None:
        ...
        prices = [p["high"] for p in list(self.price_history)] + [p["low"] for p in list(self.price_history)]
