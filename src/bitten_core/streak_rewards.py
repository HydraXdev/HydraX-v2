...
class StreakRewardSystem:
    ...
    MILESTONE_REWARDS = {
        ...
        14: {
            ...
            "items": [
                {
                    "id": "premium_signals_day",
                    "name": "Premium Signals (24h)",
                    "type": "access",
                    "tier": "rare",
                    "quantity": 1,
                },
        ...
        21: {
            ...
            "items": [
                {
                    "id": "exclusive_indicator",
                    "name": "Exclusive Indicator Access",
                    "type": "tool",
                    "tier": "epic",
                    "quantity": 1,
                },
            ...
            "badges": [
                {
                    "id": "three_week_sniper",
                    "name": "Three Week Sniper",
                    "type": "milestone",
                    "tier": "epic",
                    "xp_bonus": 0.12,
                }
            ],
            "titles": [{"id": "consistent_trader", "name": "Consistent Trader", "rank": "soldier", "prestige": 1}],
        ...
        30: {
            ...
            "items": [
                {
                    "id": "monthly_master_badge",
                    "name": "Monthly Master Badge",
                    "type": "cosmetic",
                    "tier": "epic",
                    "quantity": 1,
                },
            ...
            "titles": [{"id": "dedicated_trader", "name": "Dedicated Trader", "rank": "veteran", "prestige": 2}],
        ...
        60: {
            ...
            "items": [
                ...
                {
                    "id": "premium_indicators_month",
                    "name": "Premium Indicators (30 days)",
                    "type": "tool",
                    "tier": "legendary",
                    "quantity": 1,
                },
            ...
            "titles": [{"id": "elite_trader", "name": "Elite Trader", "rank": "elite", "prestige": 3}],
        ...
        90: {
            ...
            "items": [
                {
                    "id": "quarterly_champion_crown",
                    "name": "Quarterly Champion Crown",
                    "type": "cosmetic",
                    "tier": "legendary",
                    "quantity": 1,
                },
                {
                    "id": "exclusive_strategy_guide",
                    "name": "Exclusive Strategy Guide",
                    "type": "education",
                    "tier": "legendary",
                    "quantity": 1,
                },
                {
                    "id": "unlimited_streak_protection",
                    "name": "Unlimited Streak Protection (30 days)",
                    "type": "protection",
                    "tier": "legendary",
                    "quantity": 1,
                },
            ...
            "titles": [{"id": "market_veteran", "name": "Market Veteran", "rank": "elite", "prestige": 4}],
        ...
        120: {
            ...
            "items": [
                {
                    "id": "stellar_performance_star",
                    "name": "Stellar Performance Star",
                    "type": "cosmetic",
                    "tier": "legendary",
                    "quantity": 1,
                },
                {
                    ...
                    "name": "AI Trading Assistant (Beta)",
                    "type": "tool",
                    "tier": "mythic",
                    "quantity": 1,
                },
        ...
        180: {
            ...
            "items": [
                {
                    "id": "half_year_medal",
                    "name": "Half-Year Hero Medal",
                    "type": "trophy",
                    "tier": "mythic",
                    "quantity": 1,
                },
                {
                    "id": "custom_trading_bot",
                    "name": "Custom Trading Bot Setup",
                    "type": "service",
                    "tier": "mythic",
                    "quantity": 1,
                },
            ...
            "titles": [{"id": "trading_legend", "name": "Trading Legend", "rank": "legend", "prestige": 5}],
            "privileges": [
                "legend_tier_access",
                "personal_trading_bot",
                "mentorship_program",
                "platform_development_input",
            ],
        },
        270: {
            "xp_base": 10000,
            ...
            "items": [
                {
                    "id": "cosmic_consistency_orb",
                    "name": "Cosmic Consistency Orb",
                    "type": "cosmetic",
                    "tier": "mythic",
                    "quantity": 1,
                },
                {
                    "id": "platform_profit_share",
                    "name": "Platform Profit Share (1 month)",
                    "type": "reward",
                    "tier": "mythic",
                    "quantity": 1,
                },
        ...
        365: {
            ...
            "items": [
                {
                    "id": "annual_legend_trophy",
                    "name": "Annual Legend Trophy",
                    "type": "trophy",
                    "tier": "mythic",
                    "quantity": 1,
                },
                {
                    "id": "platform_ownership_share",
                    "name": "Platform Ownership Share",
                    "type": "equity",
                    "tier": "mythic",
                    "quantity": 1,
                },
                {
                    "id": "custom_feature_request",
            ...
            "titles": [{"id": "immortal_trader", "name": "Immortal Trader", "rank": "mythic", "prestige": 10}],
            "privileges": [
                "immortal_tier_access",
                "platform_ownership",
                "hall_of_fame",
    ...
    def calculate_comeback_bonus(self, days_away: int) -> Dict[str, Any]:
        ...
        return {"multiplier": bonus_multiplier, "message": message, "bonus_items": bonus_items, "days_away": days_away}
    ...
    def calculate_total_badge_bonuses(self, user_badges: List[Badge]) -> Dict[str, float]:
        ...
        return {"xp_bonus": total_xp_bonus, "trading_bonus": total_trading_bonus, "badge_count": len(user_badges)}
