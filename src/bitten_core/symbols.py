...
def price_plus_pips(symbol: str, entry: float, direction: str, pips: float, side: str = "mid") -> float:
    """
...
def be_offset_pips(symbol: str, current_spread_pips: float, broker_min_stop: Optional[int] = None) -> float:
    """
...
def calculate_trail_distance(symbol: str, atr_value: float, method: str = "ATR") -> float:
    """
...
def validate_sl_distance(symbol: str, entry: float, sl: float, direction: str) -> Tuple[bool, str]:
    """
