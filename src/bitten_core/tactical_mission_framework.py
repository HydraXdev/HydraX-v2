...
class TacticalMissionFramework:
    ...
    def create_operation_normandy_echo(
        self, user_id: str, signal_data: Dict, user_tier: str = "RECRUIT"
    ) -> OperationNormandyEcho:
    ...
    def _create_normandy_echo_objectives(self, user_context, signal_data: Dict) -> List[LearningObjectiveDisguised]:
        ...
        objectives = [
            LearningObjectiveDisguised(
                ...
                completion_criteria={"trade_executed": True, "position_size_appropriate": True, "stop_loss_set": True},
...
def create_first_live_trade_mission(
    user_id: str, signal_data: Dict, user_tier: str = "RECRUIT"
) -> OperationNormandyEcho:
