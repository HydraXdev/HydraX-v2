    ...
    def _define_strategies(self) -> Dict[str, TacticalStrategy]:
        ...
        return {
            ...
            "FIRST_BLOOD": TacticalStrategy(
                ...
                special_rules={"escalating_tcs": [75, 78, 80, 85], "stop_after_wins": 2, "escalation_mode": True},
                risk_reward=1.5,
            ...
            "DOUBLE_TAP": TacticalStrategy(
                ...
                max_trades=2,
                min_tcs=85,
                special_rules={"same_direction": True, "precision_mode": True, "high_reward": True},
                risk_reward=1.8,
        ...
        try:
            ...
            if not tracking:
                ...
                self.conn.execute(
                    ...
                    VALUES (?, ?, ?, 1, ?, ?, ?)
                """,
                    (user_id, today, strategy, mission.direction, now.isoformat(), now.isoformat()),
                )
            else:
                ...
                """,
                    (new_trades, mission.direction, now.isoformat(), user_id, today, strategy),
                )
    ...
    def record_trade_result(self, user_id: str, mission_id: str, result: Dict) -> bool:
        ...
        try:
            ...
            self.conn.execute(
                ...
                WHERE user_id = ? AND mission_id = ?
            """,
                ("WIN" if success else "LOSS", pnl, user_id, mission_id),
            )
            ...
            if tracking:
                ...
                self.conn.execute(
                    ...
                    WHERE user_id = ? AND date = ? AND strategy = ?
                """,
                    (new_wins, new_pnl, strategy_completed, now.isoformat(), user_id, today, strategy),
                )
...
if __name__ == "__main__":
    ...
    test_signal = {"symbol": "EURUSD", "direction": "BUY", "tcs_score": 80}
