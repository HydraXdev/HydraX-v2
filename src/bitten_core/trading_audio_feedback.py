...
from .ambient_audio_system import AudioClip, AudioMood, AudioType, TradingContext, ambient_audio_engine
...
class TradingAudioFeedbackEngine:
    ...
    def _setup_feedback_rules(self):
        ...
        rules = {
            ...
            "good_decision": FeedbackRule(
                ...
                conditions={"tcs_score_min": 75, "risk_percentage_max": 2.5},
                feedback_type=FeedbackType.APPROVAL,
            ...
            "risky_decision": FeedbackRule(
                ...
                conditions={"tcs_score_max": 70, "risk_percentage_min": 3.0},
                feedback_type=FeedbackType.CAUTION,
                audio_clips=["caution_chirp_questioning", "caution_trill_concerned"],
                story_phase_modifiers={StoryPhase.EARLY_STRUGGLE: {"extra_concern": True}},
                cooldown_minutes=1,
                priority=7,
            ),
            "dangerous_decision": FeedbackRule(
                ...
                conditions={"tcs_score_max": 60, "risk_percentage_min": 4.0},
            ...
            "very_dangerous": FeedbackRule(
                ...
                conditions={"tcs_score_max": 50, "risk_percentage_min": 5.0},
                feedback_type=FeedbackType.WARNING,
            ...
            "big_win_celebration": FeedbackRule(
                ...
                conditions={"trade_outcome": TradeOutcome.BIG_WIN},
                feedback_type=FeedbackType.CELEBRATION,
                audio_clips=["celebration_trill_excited", "celebration_purr_victory"],
                story_phase_modifiers={StoryPhase.EARLY_STRUGGLE: {"extra_excitement": True}},
                cooldown_minutes=5,
                priority=9,
            ),
            "loss_comfort": FeedbackRule(
                ...
                name="Loss Comfort",
                conditions={"trade_outcome": [TradeOutcome.SMALL_LOSS, TradeOutcome.BIG_LOSS]},
                feedback_type=FeedbackType.COMFORT,
                audio_clips=["comfort_purr_healing", "comfort_chirp_supportive"],
                story_phase_modifiers={StoryPhase.EARLY_STRUGGLE: {"extended_comfort": True}},
                cooldown_minutes=10,
                priority=8,
            ),
            "patience_teaching": FeedbackRule(
                ...
                conditions={"impatient_behavior": True, "market_conditions": ["choppy", "uncertain"]},
            ...
            "discipline_reward": FeedbackRule(
                ...
                conditions={"followed_rules": True, "risk_adherence": True},
                feedback_type=FeedbackType.DISCIPLINE,
                audio_clips=["discipline_chirp_approval", "discipline_purr_proud"],
                story_phase_modifiers={StoryPhase.DISCIPLINE: {"reinforcement": True}},
                cooldown_minutes=20,
                priority=5,
            ),
            "confidence_building": FeedbackRule(
                ...
                conditions={"consecutive_wins": 2, "improving_performance": True},
    ...
    def _setup_bit_personality_responses(self):
        ...
        self.personality_responses = {
            ...
            StoryPhase.AWAKENING: {"encouraging": True, "celebrates_small_wins": True, "guidance_focused": True},
            StoryPhase.DISCIPLINE: {
                "reinforces_good_habits": True,
                "stricter_on_rules": True,
                "proud_of_progress": True,
            },
            StoryPhase.MASTERY: {"confident_companion": True, "celebrates_expertise": True, "subtle_guidance": True},
            StoryPhase.LEGACY: {
                "wise_companion": True,
    ...
    def _record_feedback(self, user_id: str, rule_id: str, feedback_type: FeedbackType):
        ...
        self.user_feedback_history[user_id].append(
            {"rule_id": rule_id, "feedback_type": feedback_type.value, "timestamp": datetime.now()}
        )
    ...
    async def provide_trade_outcome_feedback(
        self, user_id: str, outcome: TradeOutcome, profit_loss: float, details: Dict[str, Any]
    ) -> Optional[str]:
        ...
        if outcome == TradeOutcome.BIG_WIN and profit_loss > 100:
            ...
            await ambient_audio_engine.play_contextual_audio(
                user_id=user_id, context=TradingContext.PROFIT_TARGET, mood=AudioMood.EXCITED
            )

        elif outcome in [TradeOutcome.BIG_LOSS, TradeOutcome.SMALL_LOSS]:
            # Comfort after losses
            await ambient_audio_engine.play_contextual_audio(
                user_id=user_id, context=TradingContext.STOP_LOSS, mood=AudioMood.CALM
            )
...
async def provide_entry_feedback(
    user_id: str, tcs_score: float, risk_percentage: float, market_conditions: Dict[str, Any]
) -> List[str]:
