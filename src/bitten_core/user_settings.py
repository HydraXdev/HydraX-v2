...
class UserSettingsManager:
    ...
    def update_user_settings(self, user_id: str, updates: Dict[str, Any]) -> UserSettings:
    ...
    def toggle_sounds(self, user_id: str, enabled: bool) -> UserSettings:
        ...
        return self.update_user_settings(user_id, {"sounds_enabled": enabled})

    def toggle_cash_register(self, user_id: str, enabled: bool) -> UserSettings:
        """Toggle cash register sound specifically"""
        return self.update_user_settings(user_id, {"cash_register_sound": enabled})
...
if __name__ == "__main__":
    ...
    updated = update_user_settings(
        "test_user", {"cash_register_sound": False, "theme": "light", "risk_percentage": 1.5}
    )
