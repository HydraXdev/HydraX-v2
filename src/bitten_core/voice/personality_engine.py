...
class PersonalityEngine:
    ...
    def assign_personality(self, user_id: str, user_tier: str = "NIBBLER", force_personality: str = None) -> str:
        ...
        profile = {
            ...
            "evolution_stage": 0,
            "adaptation_factors": {"success_rate": 0.5, "engagement_level": 0.5, "interaction_frequency": 0.5},
        }
        ...
        if trigger_type == "tier_advancement":
            ...
            if pattern_type in EVOLUTION_TRIGGERS["interaction_patterns"]:
                ...
                for trait, change in adaptations.items():
                    ...
                    profile["adaptation_factors"][trait] = max(
                        0.0, min(1.0, profile["adaptation_factors"][trait] + change)
                    )
                    evolution_needed = True
    ...
    def update_on_xp_change(self, user_id: str, new_xp: int, new_tier: str):
        ...
        return self.evolve_personality(user_id, "tier_advancement", {"new_tier": new_tier, "new_xp": new_xp})
    ...
    def update_on_user_action(self, user_id: str, action: str, success: bool = True):
        ...
        if behavior_type:
            return self.evolve_personality(
                user_id, "behavior_adaptation", {"behavior_type": behavior_type, "success": success}
            )
