...
try:
    from .bit_personality import bit, bit_react_trade, get_bit_response
...
VOICE_PERSONALITY_MAP = {
    ...
    "DRILL": {
        ...
        "speech_patterns": {
            ...
            "reinforcement": [
                ...
                "KNOWLEDGE PREVENTS FAILURE",
                "SELF-DISCIPLINE IS YOUR ONLY SHIELD",
            ],
        },
        "contextual_responses": {
        ...
        "triggers": {"fast_execution": 0.3, "high_risk": 0.4, "frequent_trading": 0.5, "loss_recovery": 0.6},
        "evolution_factors": {
    ...
    "DOC_AEGIS": {
        ...
        "speech_patterns": {
            ...
            "bit_integration": [
                "*BIT's eyes glow approvingly*",
                "*BIT purrs with satisfaction*",
                "*BIT's tactical sensors confirm*",
                "*BIT performs protective capital scan*",
                "*BIT's whiskers twitch at market movement*",
                "*BIT curls up around your portfolio*",
                "*BIT stretches and flexes digital claws*",
                "*BIT nods with feline approval*",
                "*BIT's tail swishes confidently*",
                "*BIT settles in for the hunt*",
            ],
        },
        "contextual_responses": {
        ...
        "moods": {
            "default": {
                ...
                "humor": 0.1,
                "aggression": 0.2,
                "voice_settings": {"stability": 0.8, "similarity_boost": 0.9, "style": 0.3},
            },
            "evolving": {
                "energy": 0.6,
                "humor": 0.3,
            ...
            "veteran": {
                ...
                "humor": 0.2,
                "aggression": 0.4,
                "voice_settings": {"stability": 0.9, "similarity_boost": 0.9, "style": 0.2},
            },
        },
        "triggers": {
    ...
    "NEXUS": {
        ...
        "moods": {
            "default": {
                ...
                "humor": 0.6,
                "aggression": 0.3,
                "voice_settings": {"stability": 0.6, "similarity_boost": 0.7, "style": 0.7},
            },
            "evolving": {
                "energy": 0.9,
                "humor": 0.8,
                "aggression": 0.4,
                "voice_settings": {"stability": 0.5, "similarity_boost": 0.6, "style": 0.8},
            },
            "veteran": {
                "energy": 0.7,
                "humor": 0.7,
    ...
    "OVERWATCH": {
        ...
        "speech_patterns": {
            "intel_reports": [
                "Intel incoming",
                "Market surveillance indicates",
                "Data correlation shows",
                "Tactical assessment complete",
            ],
            "strategic_language": [
                "Strategic positioning",
                "Market theater analysis",
        ...
        "moods": {
            ...
            "evolving": {
                ...
                "humor": 0.2,
                "aggression": 0.6,
                "voice_settings": {"stability": 0.6, "similarity_boost": 0.7, "style": 0.5},
            },
            "veteran": {
                "energy": 0.5,
                "humor": 0.3,
    ...
    "STEALTH": {
        ...
        "speech_patterns": {
            ...
            "rare_longer_phrases": [
                "Target acquired. Precision strike recommended.",
                "Market noise filtered. Signal isolated.",
            ],
        },
        "contextual_responses": {
            "trade_success": "...",
        ...
        "moods": {
            ...
            "evolving": {
                ...
                "humor": 0.1,
                "aggression": 0.7,
                "voice_settings": {"stability": 0.8, "similarity_boost": 0.8, "style": 0.3},
            },
            "veteran": {
                "energy": 0.4,
                "humor": 0.0,
                "aggression": 0.8,
                "voice_settings": {"stability": 0.9, "similarity_boost": 0.9, "style": 0.1},
            },
        },
        "triggers": {"stealth_mode": 0.6, "precision_trades": 0.5, "minimal_communication": 0.4, "sniper_signals": 0.7},
        "evolution_factors": {
            "precision_rate": 0.4,
    ...
    "ATHENA": {
        ...
        "speech_patterns": {
            ...
            "tactical_guidance": [
                ...
                "Strike zone acquired",
            ],
            "protective_responses": [
                "Mission parameters held",
        ...
        "moods": {
            "default": {
                ...
                "humor": 0.2,
                "aggression": 0.7,
                "voice_settings": {"stability": 0.75, "similarity_boost": 0.80, "style": 0.70},
            },
            "evolving": {
                "energy": 0.9,
                "humor": 0.3,
                "aggression": 0.8,
                "voice_settings": {"stability": 0.70, "similarity_boost": 0.85, "style": 0.75},
            },
            "veteran": {
                "energy": 0.85,
                "humor": 0.4,
                "aggression": 0.9,
                "voice_settings": {"stability": 0.80, "similarity_boost": 0.90, "style": 0.65},
            },
        },
        "triggers": {
