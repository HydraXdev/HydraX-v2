    ...
    def decorator(f: Callable) -> Callable:
        ...
        def decorated_function(*args, **kwargs):
            ...
            if client_id not in rate_limit_storage:
                rate_limit_storage[client_id] = {"requests": [], "blocked_until": 0}
            ...
            if current_time < client_data["blocked_until"]:
                ...
                return jsonify({"error": "Rate limit exceeded", "retry_after": remaining}), 429

            # Clean old requests outside the window
            client_data["requests"] = [
                req_time for req_time in client_data["requests"] if current_time - req_time < window
            ]
