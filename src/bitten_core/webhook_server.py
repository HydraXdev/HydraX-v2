...
class WebhookServer:
    ...
    def setup_routes(self):
        ...
        def health():
            ...
            return jsonify({"status": "healthy", "service": "BITTEN Trading Operations Center", "version": "1.0.0"})
        ...
        def news():
            ...
            try:
                ...
                return jsonify({"scheduler": status, "upcoming_events": events_data, "total_events": len(events_data)})
            except Exception as e:
