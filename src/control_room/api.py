...
async def get_patterns_report(
    ...
    try:
        ...
        if not results:
            ...
            return [
                {
                    "pattern_name": "ORDER_BLOCK_BOUNCE",
                    "signal_count": 87,
                    "win_rate_pct": 37.1,
                    "expectancy_r": 0.13,
                    "avg_pl_dollars": 12.45,
                    "avg_pl_pips": 8.2,
                },
                {
                    ...
                    "win_rate_pct": 71.4,
                    "expectancy_r": 1.87,
                    "avg_pl_dollars": 34.67,
                    "avg_pl_pips": 15.3,
                },
                {
                    "pattern_name": "VCB_BREAKOUT",
                    "signal_count": 156,
                    "win_rate_pct": 68.2,
                    "expectancy_r": 1.45,
                    "avg_pl_dollars": 28.91,
                    "avg_pl_pips": 12.7,
                },
                {
                    "pattern_name": "FAIR_VALUE_GAP_FILL",
                    "signal_count": 93,
                    "win_rate_pct": 42.8,
                    "expectancy_r": 0.34,
                    "avg_pl_dollars": 18.23,
                    "avg_pl_pips": 9.8,
                },
                {
...
async def get_trends_report(
    ...
    try:
        ...
        for row in equity_results:
            equity_curve.append({"timestamp": row.get("timestamp", ""), "cumulative_pl": row.get("cumulative_pl", 0.0)})
        ...
        if not equity_curve and not hourly_rates:
            ...
            for i in range(30):
                ...
                mock_equity.append({"timestamp": date, "cumulative_pl": random.random() * 1000 + i * 50})

            mock_hourly = []
            for hour in range(24):
                mock_hourly.append(
                    {"hour_utc": hour, "win_rate_pct": 45 + random.random() * 30, "signal_count": random.randint(5, 50)}
                )

            return {"equity_curve": mock_equity, "hourly_rates": mock_hourly}

        return {"equity_curve": equity_curve, "hourly_rates": hourly_rates}
            ...
            return [
                {
                    ...
                    "actual_trades": 1,
                    "win_rate_pct": 0.0,
                    "total_pl_dollars": -18.45,
                    "allow_signal_notifications": True,
                },
                {
                    "id": 2,
                    "username": "trader2",
                    ...
                    "actual_trades": 1,
                    "win_rate_pct": 100.0,
                    "total_pl_dollars": 42.67,
                    "allow_signal_notifications": False,
                },
                {
                    "id": 3,
                    "username": "elite_user",
...
async def toggle_kill_switch(request: KillSwitchRequest):
    ...
    try:
        ...
        details = {"enabled": request.enabled, "reason": request.reason, "auto_triggered": False}
