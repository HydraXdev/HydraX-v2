...
def insert_sample_data(cursor: sqlite3.Cursor):
    ...
    sample_signals = [
        (
            "2025-09-01 08:15:00",
            "ELITE_SNIPER_EURUSD_1725177300",
            "LONDON",
            "ORDER_BLOCK_BOUNCE",
            "EURUSD",
            37.1,
        ...
        (
            "2025-09-01 14:30:00",
            "ELITE_SNIPER_GBPUSD_1725199800",
            "NY",
        ...
        (
            "2025-09-01 16:45:00",
            "ELITE_SNIPER_XAUUSD_1725207900",
            "NY",
            "VCB_BREAKOUT",
            "XAUUSD",
            68.2,
        ...
        (
            "2025-09-02 03:20:00",
            "ELITE_SNIPER_USDJPY_1725246000",
            "TOKYO",
            "FAIR_VALUE_GAP_FILL",
            "USDJPY",
            42.8,
        ...
        (
            "2025-09-02 09:45:00",
            "ELITE_SNIPER_USDCHF_1725269100",
            "LONDON",
            "MOMENTUM_BREAKOUT",
            "USDCHF",
            71.4,
        ...
        (
            "2025-09-02 11:20:00",
            "ELITE_SNIPER_GBPJPY_1725276000",
            "LONDON",
            "SWEEP_AND_RETURN",
            "GBPJPY",
            65.8,
        ...
        (
            "2025-09-02 15:35:00",
            "ELITE_SNIPER_EURJPY_1725291300",
            "NY",
            "EMA_RSI_SCALP",
            "EURJPY",
            59.7,
        ...
        (
            "2025-09-03 07:10:00",
            "ELITE_SNIPER_AUDUSD_1725346200",
            "LONDON",
            "BB_SCALP",
            "AUDUSD",
            61.2,
        ...
        (
            "2025-09-03 12:25:00",
            "ELITE_SNIPER_NZDUSD_1725365100",
            "NY",
            "KALMAN_QUICKFIRE",
            "NZDUSD",
            75.6,
        ...
        (
            "2025-09-03 18:40:00",
            "ELITE_SNIPER_EURGBP_1725387600",
            "LONDON",
            "ORDER_BLOCK_BOUNCE",
            "EURGBP",
            45.3,
...
def insert_sample_actions(cursor: sqlite3.Cursor):
    ...
    sample_actions = [
        (
            ...
            "SIGNAL_LOG",
            "SUCCESS",
            '{"signal_id": "ELITE_SNIPER_EURUSD_1725177300", "pair": "EURUSD", "pattern": "ORDER_BLOCK_BOUNCE"}',
        ),
        (
            "2025-09-07 08:16:00",
            None,
            "SYSTEM_STATUS",
            "SUCCESS",
            '{"signals_per_hour": 12, "active_users": 7, "kill_switch": false}',
        ),
        (
            "2025-09-07 09:30:00",
            3,
            "SIGNAL_LOG",
            "SUCCESS",
            '{"signal_id": "ELITE_SNIPER_GBPUSD_1725199800", "pair": "GBPUSD", "pattern": "LIQUIDITY_SWEEP_REVERSAL"}',
        ),
        (
            "2025-09-07 09:45:00",
            1,
            "KILL_SWITCH",
            "SUCCESS",
            '{"enabled": false, "reason": "Manual toggle", "duration_minutes": 15}',
        ),
        (
            "2025-09-07 10:00:00",
            1,
            "TOGGLE_LEROY",
            "SUCCESS",
            '{"enabled": true, "mode": "aggressive", "threshold_adjustment": 5}',
        ),
        (
            "2025-09-07 10:30:00",
            5,
            "SIGNAL_LOG",
            "SUCCESS",
            '{"signal_id": "ELITE_SNIPER_XAUUSD_1725207900", "pair": "XAUUSD", "pattern": "VCB_BREAKOUT"}',
        ),
        (
            "2025-09-07 11:15:00",
            None,
            "SYSTEM_STATUS",
            "SUCCESS",
            '{"signals_per_hour": 8, "active_users": 9, "kill_switch": false}',
        ),
        (
            "2025-09-07 12:00:00",
            2,
            "SIGNAL_LOG",
            "SUCCESS",
            '{"signal_id": "ELITE_SNIPER_USDJPY_1725246000", "pair": "USDJPY", "pattern": "FAIR_VALUE_GAP_FILL"}',
        ),
        (
            "2025-09-07 12:30:00",
            4,
            "SIGNAL_LOG",
            "SUCCESS",
            '{"signal_id": "ELITE_SNIPER_USDCHF_1725269100", "pair": "USDCHF", "pattern": "MOMENTUM_BREAKOUT"}',
        ),
        (
            "2025-09-07 13:00:00",
            1,
            "KILL_SWITCH",
            "SUCCESS",
            '{"enabled": true, "reason": "High volatility", "auto_triggered": true}',
        ),
        (
            "2025-09-07 13:15:00",
            6,
            "SIGNAL_LOG",
            "SUCCESS",
            '{"signal_id": "ELITE_SNIPER_GBPJPY_1725276000", "pair": "GBPJPY", "pattern": "SWEEP_AND_RETURN"}',
        ),
        (
            "2025-09-07 14:00:00",
            1,
            "TOGGLE_LEROY",
            "SUCCESS",
            '{"enabled": false, "mode": "conservative", "threshold_adjustment": -3}',
        ),
        (
            "2025-09-07 14:30:00",
            7,
            "SIGNAL_LOG",
            "SUCCESS",
            '{"signal_id": "ELITE_SNIPER_EURJPY_1725291300", "pair": "EURJPY", "pattern": "EMA_RSI_SCALP"}',
        ),
        (
            "2025-09-07 15:00:00",
            None,
            "SYSTEM_STATUS",
            "SUCCESS",
            '{"signals_per_hour": 15, "active_users": 12, "kill_switch": true}',
        ),
        (
            "2025-09-07 15:30:00",
            8,
            "SIGNAL_LOG",
            "SUCCESS",
            '{"signal_id": "ELITE_SNIPER_AUDUSD_1725346200", "pair": "AUDUSD", "pattern": "BB_SCALP"}',
        ),
        (
            "2025-09-07 16:00:00",
            1,
            "KILL_SWITCH",
            "SUCCESS",
            '{"enabled": false, "reason": "Manual disable", "duration_minutes": 45}',
        ),
        (
            "2025-09-07 16:15:00",
            9,
            "SIGNAL_LOG",
            "SUCCESS",
            '{"signal_id": "ELITE_SNIPER_NZDUSD_1725365100", "pair": "NZDUSD", "pattern": "KALMAN_QUICKFIRE"}',
        ),
        (
            "2025-09-07 17:00:00",
            10,
            "SIGNAL_LOG",
            "SUCCESS",
            '{"signal_id": "ELITE_SNIPER_EURGBP_1725387600", "pair": "EURGBP", "pattern": "ORDER_BLOCK_BOUNCE"}',
        ),
        (
            "2025-09-07 17:30:00",
            1,
            "TOGGLE_LEROY",
            "SUCCESS",
            '{"enabled": true, "mode": "balanced", "threshold_adjustment": 0}',
        ),
        (
            "2025-09-07 18:00:00",
            None,
            "SYSTEM_STATUS",
            "SUCCESS",
            '{"signals_per_hour": 10, "active_users": 8, "kill_switch": false}',
        ),
        ...
        (
            ...
            "SIGNAL_LOG",
            "SUCCESS",
            '{"signal_id": "ELITE_SNIPER_CADJPY_1725398400", "pair": "CADJPY", "pattern": "LIQUIDITY_SWEEP_REVERSAL"}',
        ),
        (
            "2025-09-07 19:00:00",
            5,
            "SIGNAL_LOG",
            "SUCCESS",
            '{"signal_id": "ELITE_SNIPER_CHFJPY_1725400200", "pair": "CHFJPY", "pattern": "VCB_BREAKOUT"}',
        ),
        (
            "2025-09-07 19:30:00",
            7,
            "SIGNAL_LOG",
            "SUCCESS",
            '{"signal_id": "ELITE_SNIPER_NZDJPY_1725402000", "pair": "NZDJPY", "pattern": "MOMENTUM_BREAKOUT"}',
        ),
        (
            "2025-09-07 20:00:00",
            None,
            "SYSTEM_STATUS",
            "SUCCESS",
            '{"signals_per_hour": 6, "active_users": 5, "kill_switch": false}',
        ),
        (
            "2025-09-07 20:30:00",
            2,
            "SIGNAL_LOG",
            "SUCCESS",
            '{"signal_id": "ELITE_SNIPER_EURAUD_1725405600", "pair": "EURAUD", "pattern": "FAIR_VALUE_GAP_FILL"}',
        ),
    ]
...
def get_database_info() -> dict:
    ...
    try:
        ...
        return {"database_path": DATABASE_PATH, "status": "error", "error": str(e)}
