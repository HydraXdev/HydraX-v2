...
from uncertainty_control_system import BitModeDecision, ControlMode, UncertaintyControlSystem
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        if self.pending_confirmation:
            status["pending_decision"] = {
                ...
                "timestamp": (
                    self.pending_confirmation.timestamp.isoformat() if self.pending_confirmation.timestamp else None
                ),
            }
