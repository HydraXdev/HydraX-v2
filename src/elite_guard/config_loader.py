...
class ConfigLoader:
    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        return {
            "pip_sizes": {"JPY": 0.01, "GOLD": 0.1, "SILVER": 0.001, "BTC": 1.0, "ETH": 0.1, "DEFAULT": 0.0001},
            ...
            "risk_management": {"default_risk_percent": 0.03, "default_account_balance": 1000.0},
            "pattern_thresholds": {
                ...
                "ORDER_BLOCK_BOUNCE": {"body_ratio": 0.6, "min_conf": 70, "vol_gate": 1.2, "zone_tolerance": 0.3},
                "FAIR_VALUE_GAP_FILL": {"gap_size": 0.5, "min_conf": 65, "vol_gate": 1.1, "fill_ratio": 0.5},
                "VCB_BREAKOUT": {"compression_ratio": 0.7, "min_conf": 70, "vol_gate": 1.5, "breakout_mult": 1.0},
                "SWEEP_RETURN": {"wick_ratio": 0.7, "min_conf": 72, "vol_gate": 1.3, "sweep_pips": 2.0},
                "MOMENTUM_BURST": {"breakout_pips": 1.0, "min_conf": 68, "vol_gate": 1.2, "momentum_mult": 1.0},
            },
        }
