...
class PerformanceLogger:
    ...
    def log_timing(self, operation: str, duration: float, metadata: Optional[Dict[str, Any]] = None):
        ...
        log_data = {"operation": operation, "duration_ms": duration * 1000, "timestamp": datetime.utcnow().isoformat()}
        if metadata:
...
class IntelligenceLogger:
    ...
    def log_event(self, event_type: str, event_data: Dict[str, Any], level: str = "INFO"):
        ...
        log_data = {"event_type": event_type, "event_data": event_data, "timestamp": datetime.utcnow().isoformat()}
