...
class DataNormalizer(DataProcessor):
    ...
    def _get_field_mappings(self) -> Dict[str, str]:
        ...
        return {"symbol": "symbol", "timestamp": "timestamp", "price": "price", "volume": "volume"}
    ...
    async def _transform_single(self, data: Dict[str, Any]) -> Optional[NormalizedData]:
        ...
        try:
            normalized = NormalizedData(source=self.source_type, raw_data=data)
    ...
    async def enrich(
        self, data: Union[NormalizedData, List[NormalizedData]]
    ) -> Union[NormalizedData, List[NormalizedData]]:
...
class SocialMediaNormalizer(DataNormalizer):
    ...
    def _get_field_mappings(self) -> Dict[str, str]:
        return {"timestamp": "created_at", "content": "text", "author": "user", "engagement": "metrics"}
