...
class BittenLoggingConfig:
    ...
    def setup_logging(self, service_name: str = "bitten-core") -> logging.Logger:
        ...
        if self.config.get("file_logging", True):
            ...
            file_handler = logging.handlers.RotatingFileHandler(
                log_file, maxBytes=self.config["max_file_size"], backupCount=self.config["backup_count"]
            )
        ...
        error_handler = logging.handlers.RotatingFileHandler(
            error_file, maxBytes=self.config["max_file_size"], backupCount=self.config["backup_count"]
        )
    ...
    def get_performance_logger(self, service_name: str = "performance") -> logging.Logger:
        ...
        perf_handler = logging.handlers.RotatingFileHandler(
            perf_file, maxBytes=self.config["max_file_size"], backupCount=self.config["backup_count"]
        )
    ...
    def get_signal_logger(self) -> logging.Logger:
        ...
        signal_handler = logging.handlers.RotatingFileHandler(
            signal_file, maxBytes=self.config["max_file_size"], backupCount=self.config["backup_count"]
        )
    ...
    def get_trade_logger(self) -> logging.Logger:
        ...
        trade_handler = logging.handlers.RotatingFileHandler(
            trade_file, maxBytes=self.config["max_file_size"], backupCount=self.config["backup_count"]
        )
    ...
    def get_health_logger(self) -> logging.Logger:
        ...
        health_handler = logging.handlers.RotatingFileHandler(
            health_file, maxBytes=self.config["max_file_size"], backupCount=self.config["backup_count"]
        )
