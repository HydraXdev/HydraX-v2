...
class MT5BridgeAdapter:
    ...
    def _cleanup_pending_trades(self):
        ...
        for trade_id in expired:
            ...
            timeout_result = TradeResult(
                trade_id=trade_id, status="timeout", message="No response from EA within timeout period"
            )
    ...
    def execute_trade(
        ...
        try:
            ...
            return {"success": False, "trade_id": trade_id, "message": str(e), "error_code": "BRIDGE_ERROR"}
...
if __name__ == "__main__":
    ...
    result = adapter.execute_trade(
        symbol="XAUUSD", direction="buy", volume=0.01, stop_loss=1950.00, take_profit=1970.00
    )
