...
from ..bitten_core.fire_router import TradeExecutionResult, TradeRequest
from .mt5_bridge_adapter import MT5BridgeAdapter, get_bridge_adapter
...
class MT5BridgeIntegration:
    ...
    def execute_trade(self, request: TradeRequest) -> TradeExecutionResult:
        ...
        try:
            ...
            return TradeExecutionResult(
                success=False, message=f"❌ Bridge error: {str(e)}", error_code="BRIDGE_EXCEPTION"
            )
...
def create_mt5_config():
    ...
    config = {
        "mt5": {
            ...
            "trade_timeout": 30,
            "symbol_mapping": {"XAUUSD": "XAUUSD", "EURUSD": "EURUSD", "GBPUSD": "GBPUSD", "USDJPY": "USDJPY"},
        }
    }
