...
from zmq_bitten_controller import TradeResult, get_bitten_controller
...
class MT5ZMQAdapter:
    ...
    def execute_trade(
        ...
        success = self.controller.send_signal(trade_request.to_zmq_payload(), callback=on_trade_result)
