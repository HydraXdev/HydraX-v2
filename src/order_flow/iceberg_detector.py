...
class IcebergDetector:
    ...
    def __init__(self, symbol: str, tick_size: float = 0.0001):
        ...
        # Pattern recognition
        self.volume_percentiles = {"small": 0.25, "medium": 0.50, "large": 0.75, "huge": 0.95}
    ...
    def update_order_flow(
        self, timestamp: datetime, price: float, volume: float, side: str, spread: float
    ...
    def _create_iceberg_signal(self, slices: List[VolumeSlice], metrics: Dict[str, Any]) -> IcebergSignal:
