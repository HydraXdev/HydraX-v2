...
class VenomActivityLogger:
    ...
    def _log_event(self, event_type: str, data: Dict[str, Any]) -> None:
        ...
        try:
            with self.lock:
                log_entry = {"timestamp": datetime.utcnow().isoformat() + "Z", "event_type": event_type, **data}
    ...
    def log_feed_monitor_heartbeat(self, container_name: str, health_status: Dict[str, Any]) -> None:
        ...
        self._log_event(
            "feed_monitor_heartbeat",
            {"component": "VenomFeedMonitor", "container_name": container_name, "health_status": health_status},
        )

    def log_venom_signal_generated(self, signal_data: Dict[str, Any]) -> None:
        """Log when VENOM engine generates a signal"""
        self._log_event(
            "venom_signal_generated",
            {
    ...
    def log_signal_to_core(
        self, signal_id: str, core_status: str, additional_data: Optional[Dict[str, Any]] = None
    ) -> None:
    ...
    def log_engine_status(self, engine_name: str, status: str, details: Optional[Dict[str, Any]] = None) -> None:
        ...
        log_data = {"component": engine_name, "status": status, "message": f"{engine_name} status: {status}"}
    ...
    def log_error(self, component: str, error_message: str, error_details: Optional[Dict[str, Any]] = None) -> None:
        ...
        log_data = {"component": component, "error_message": error_message, "severity": "error"}
