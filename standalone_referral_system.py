...
class StandaloneReferralSystem:
    ...
    def generate_referral_code(
        self, user_id: str, custom_code: Optional[str] = None
        ...
        try:
            ...
            return (
                True,
                f"✅ **REFERRAL CODE GENERATED!**\n🎯 **Your Personal Recruit Link:**\nhttps://joinbitten.com/recruit/{code}",
                code,
            )
    ...
    def use_referral_code(
        self, code: str, recruit_id: str, username: str, ip_address: str
    ...
    def _check_rate_limit(self, ip_address: str, user_id: str) -> bool:
        ...
        if ip_address in self.ip_tracker:
            self.ip_tracker[ip_address] = [
                timestamp
                for timestamp in self.ip_tracker[ip_address]
