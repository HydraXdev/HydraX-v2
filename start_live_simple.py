...
class SimpleTelegramBot:
    ...
    async def send_signal(self, signal: Dict):
        ...
        keyboard = {
            "inline_keyboard": [[{"text": "🎯 VIEW INTEL", "url": f"https://joinbitten.com/mission/{signal['id']}"}]]
        }
...
class SimpleMarketAnalyzer:
            ...
            try:
                ...
                if "quotes" in data:
                    ...
                    for quote in data["quotes"]:
                        rates[quote["instrument"]] = {"bid": quote["bid"], "ask": quote["ask"], "mid": quote["mid"]}
                    return rates
            except:
                pass
    ...
    def get_simulated_rates(self) -> Dict:
        ...
        base_prices = {"EURUSD": 1.0950, "GBPUSD": 1.2650, "USDJPY": 150.50, "XAUUSD": 1950.00}
        ...
        for symbol, base in base_prices.items():
            ...
            rates[symbol] = {"bid": mid - spread / 2, "ask": mid + spread / 2, "mid": mid}
...
async def main():
    ...
    bot = SimpleTelegramBot(token=ENV.get("TELEGRAM_BOT_TOKEN"), chat_id=ENV.get("TELEGRAM_CHAT_ID"))

    analyzer = SimpleMarketAnalyzer(api_key=ENV.get("TRADERMADE_API_KEY"))
