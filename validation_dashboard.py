...
class ValidationDashboard:
    ...
    def get_system_health(self):
        ...
        try:
            result = subprocess.run(["pgrep", "-f", "outcome_mirrorer"], capture_output=True, text=True)
    ...
    def get_dashboard_data(self):
        ...
        return {
            ...
            "deltas": {"outcome_delta_pct": 0.0, "pips_delta_pct": 0.0},  # Perfect match in current test
            "tests": {
                "Parity Check": {
