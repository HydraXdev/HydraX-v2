#!/usr/bin/env python3
"""Enhanced Flask server with improved UX and accessibility"""
...
# Enhanced HUD template with better accessibility
HUD_TEMPLATE = """
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        * {
        ...
        /* Remove floating X button - redundant with back button */
...
<body>
    <div class="top-bar">
        ...
        <div class="tier-badge">{{ tier|upper }}</div>
    </div>
    ...
    <div class="content">
        <div class="mission-card">
            ...
            <!-- Action Buttons -->
            <div class="actions">
                <button class="fire-button" onclick="fireSignal()">
                    🎯 FIRE SIGNAL
                </button>
            ...
            <div class="bottom-links">
                <a href="/education/{{ tier }}" target="_blank">
                    <span>📚</span>
                    <span>Training</span>
                </a>
...
@app.route('/hud')
def hud():
    """Mission briefing HUD with data from URL parameter"""
    try:
        ...
        context = {
            'tier': 'nibbler',  # Default, should come from user data
            'user_id': 'demo',  # Should come from auth
            ...
            'colors': get_tier_styles('nibbler')  # Should be based on user tier
        }
