...
class ZMQMarketDataReceiver:
    ...
    def __init__(self, zmq_endpoint="tcp://localhost:5555"):
        ...
        # Performance metrics
        self.stats = {"messages_received": 0, "bytes_received": 0, "errors": 0, "start_time": time.time()}
...
def get_all_market_data():
    ...
    if receiver:
        ...
        if request.args.get("fast") == "true":
            ...
            sorted_symbols = sorted(data.keys(), key=lambda s: receiver.last_update.get(s, 0), reverse=True)[:10]
