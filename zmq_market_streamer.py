...
class ZMQMarketStreamer:
    ...
    def __init__(
        self, zmq_subscribe_endpoint: str = "tcp://134.199.204.67:5555", venom_endpoint: str = "tcp://127.0.0.1:5556"
    ):
        """
    ...
    def publish_to_venom(self, tick_data: Dict):
        ...
        try:
            ...
            venom_message = {"type": "market_tick", "data": tick_data, "server_time": datetime.utcnow().isoformat()}
...
def main():
    ...
    parser.add_argument("--subscribe", type=str, default="tcp://134.199.204.67:5555", help="EA publisher endpoint")
    parser.add_argument("--publish", type=str, default="tcp://127.0.0.1:5556", help="VENOM subscriber endpoint")
    ...
    streamer = ZMQMarketStreamer(zmq_subscribe_endpoint=args.subscribe, venom_endpoint=args.publish)
