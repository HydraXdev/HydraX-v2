...
from zmq_telemetry_service import TelemetryIngestionService, integrate_with_risk_system, integrate_with_xp_system
        ...
        try:
            ...
            while self.running:
                ...
                if stats["last_update"]:
                    print(
                        f"\r📊 Telemetry: {stats['telemetry_received']} | "
                        f"Trades: {stats['trade_results_received']} | "
                        f"Active users: {stats['active_users_count']}",
                        end="",
                        flush=True,
                    )
